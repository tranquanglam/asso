...
function editContent(id) {
    ...
    var colorid = $('#item_'+id).find('.item_colorid').html();
    $('#itemForm').find('select[name="colorid"]').val(colorid);
    var sizeid = $('#item_'+id).find('.item_sizeid').html();
    $('#itemForm').find('select[name="sizeid"]').val(sizeid);
