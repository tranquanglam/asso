...
LadiPageScriptV2.prototype.init = function () {
    this.const = {
        ...
        FORM_CONFIG_TYPE: {
            ...
            shopify: "SHOPIFY",
            nhanh_vn: "NHANH_VN",
            google_recaptcha_invisible: "GOOGLE_RECAPTCHA",
...
LadiPageScriptV2.prototype.loadDataset = function (t, e, i, a, n, o, r, s) {
    ...
    for (var e = this, i = 0, a = [], n = document.querySelectorAll(".ladi-section[data-global-id]"), o = 0; o < n.length; o++) {
        var r = n[o], s = r.getAttribute("data-global-id");
        e.isEmpty(s) || a.push({id: r.id, data_global_id: s})
    }
    var l = function (n) {
        e.isObject(n) && Object.keys(n).forEach(function (t) {
            e.runtime.eventDataGlobal[t] = n[t]
        });
        i == a.length && (document.querySelectorAll('.ladi-section-global[data-dataset="true"]').length > 0 && !e.runtime.has_dataset && (e.runtime.has_dataset = !0, e.runtime.hasOwnProperty("cdn_url") && e.runtime.hasOwnProperty("version") && e.loadScript(e.runtime.cdn_url + "dataset.min.js?v=" + e.runtime.version)), e.runtime.isLoadHtmlGlobal = !0, e.run(t))
    };
    a.forEach(function (t) {
        var a = t.id, n = document.getElementById(a),
        ...
        e.sendRequest("GET", o, null, !0, null, function (o, r, s) {
            if (s.readyState == XMLHttpRequest.DONE) {
                ...
                d.innerHTML = o, LadiPageScript.isEmpty(d.querySelector('div.ladi-section-global[data-id="' + t.id + '"] .ladi-section[data-global-id="' + t.data_global_id + '"]')) ? n.parentElement.removeChild(n) : n.outerHTML = o, function (t) {
                    i++;
                    var a = document.querySelector('.ladi-section-global[data-id="' + t + '"] > script');
                    if (e.isEmpty(a)) l(); else {
                        var n = null;
                        try {
    ...
    for (var s = this, l = [], d = [], c = e.parentElement.children, p = 0; p < c.length; p++) c[p].id != e.id && c[p].classList.contains("ladi-element") && d.push(c[p]);
    ...
    for (var _ = function (t) {
        ...
        if ((e = e ? t.id != s.runtime.builder_section_popup_id : e) && "fixed" == getComputedStyle(t).position && (!t.classList.contains("ladi-element") || 0 == t.getElementsByClassName("ladi-popup").length) && (e = !1, t.classList.contains("ladi-section"))) {
            var i = s.runtime.eventData[t.id], a = s.runtime.isDesktop ? s.const.DESKTOP : s.const.MOBILE;
            s.isEmpty(i) || i[a + ".option.sticky_position"] != s.const.POSITION_TYPE.top || (e = !0)
        }
        return e
    }, y = n - a, g = parseFloatLadiPage(getComputedStyle(e).top) || 0, f = function (t) {
    ...
    var E = 0, P = 0;
    if (!this.isEmpty(i) && 0 != y && _(i) && (E = parseFloatLadiPage(getComputedStyle(i).height) || 0, P = parseFloatLadiPage(E + y) || 0, o && (i.classList.add("transition-parent-collapse-height"), s.runTimeout(function () {
        i.classList.remove("transition-parent-collapse-height")
    }, 1e3 * parseFloatLadiPage(getComputedStyle(i).transitionDuration))), i.style.setProperty("height", P + "px"), l.push(i.id)), E != P) {
    ...
    if (!a.isEmpty(n)) {
        var r = document.getElementById(t + "_button_unmute"), s = a.isEmpty(r);
    ...
    var c = this, p = c.runtime.isVideoButtonUnmute;
    ...
    var u = function (t, i) {
        if (p && !t.hasAttribute("data-remove-button-unmute")) {
            ...
            c.isEmpty(n) && ((n = document.createElement("div")).id = a, n.innerHTML = "<div></div>", n.className = "button-unmute ladi-hidden", n.addEventListener("click", function (i) {
            ...
            c.isEmpty(o) || (n.style.setProperty("width", getComputedStyle(t).width), n.style.setProperty("height", getComputedStyle(t).height))
        }
    ...
    if (!c.isEmpty(m)) {
        ...
        if (!c.isEmpty(_)) {
            ...
            if (!c.isEmpty(g)) {
                ...
                f.toLowerCase().startsWith('url("') && f.toLowerCase().endsWith('")') && (f = (f = f.substr('url("'.length)).substr(0, f.length - '")'.length), c.isEmpty(f) || (y = f))
            }
        }
        if (e == c.const.VIDEO_TYPE.youtube) {
            var h = c.getVideoId(e, i), v = function () {
                try {
                    ...
                    }, c.loadScript("//www.youtube.com/iframe_api")), !c.runtime.isYouTubeIframeAPIReady) return void c.runtime.list_youtube_ready_exec.push(v);
                    ...
                    new window.YT.Player(t, {
                        ...
                        events: {
                            onReady: _, onStateChange: function (i) {
                                if (i.data == window.YT.PlayerState.PLAYING) {
                                    ...
                                    c.isEmpty(o) || window.YT.get(t).mute()
                                }
    ...
    if (!this.isEmpty(r)) {
        ...
        if (o || n || this.pauseAllVideo(), this.isEmpty(s)) {
            var l = r.getElementsByClassName("ladi-video")[0], d = t + "_player";
            ...
            if (0 != n.length) {
                ...
                var d = function (i, a) {
                    if (!t.isEmpty(i)) {
                        ...
                        for (var o = i; !t.isEmpty(o.nextElementSibling);) (o = o.nextElementSibling).classList.remove("active");
    ...
    try {
        for (var e = document.querySelectorAll(".ladi-section .ladi-section-background iframe.ladi-section-background-video"), i = 0; i < e.length; i++) {
            ...
            if (!(n <= 0 || o <= 0)) {
                var r = t.findAncestor(a, "ladi-section-background"), s = r.clientWidth, l = o / n * s;
                l < r.clientHeight && (s = r.clientHeight / l * s, l = r.clientHeight);
                var d = (r.clientHeight - l) / 2, c = (r.clientWidth - s) / 2;
    ...
    if (t && e.isObject(e.runtime.story_page)) {
        ...
        for (var s = document.querySelectorAll(".ladi-gallery .ladi-gallery-view-item.selected:not(.ladi-lazyload)"), l = 0; l < s.length; l++) if (e.isEmpty(s[l].getAttribute("data-lazyload"))) {
    ...
    try {
        var r = window.ladi("LADI_CAMP_END_DATE").get_cookie(), s = window.ladi("LADI_CAMP_CONFIG").get_cookie();
        if (!t.isEmpty(r) && !t.isEmpty(s)) {
            ...
            if (l > 0 && t.isArray(s.dynamic_content.cookie)) {
                ...
                s.dynamic_content.cookie.forEach(function (e) {
                    var i = e.split("=");
                    2 != (i = i.removeSpace()).length || t.isEmpty(i[0]) || t.isEmpty(i[1]) || d.push({
                        name: i[0],
                        value: i[1]
                    })
    ...
    if (i.forEach(function (e) {
        ...
        c = document.querySelector(o), t.isEmpty(c) || t.isEmpty(c.id) || !c.classList.contains("ladi-section") || (window.ladi(c.id).scroll(!1, !0), o = null)
    } catch (t) {
    }
    ...
    var i = this.createTmpElement("a", "", {href: t}), a = this.getURLSearchParams(e, null, !1), n = a.utm_source;
    if (!this.isEmpty(n)) {
        n = "utm_source=" + encodeURIComponent(n);
        var o = a.utm_medium, r = a.utm_campaign, s = a.utm_term, l = a.utm_content;
    ...
    var a = this, n = {}, o = this.isNull(t);
    if (t = o ? window.location.search : t, !this.isEmpty(t)) for (var r = t.substr(1).split("&"), s = 0; s < r.length; ++s) {
        var l = r[s].split("=", 2);
    ...
    this.sendRequestWithOption(t, e, i, a, n, null, o)
}, LadiPageScriptV2.prototype.sendRequestWithOption = function (t, e, i, a, n, o, r) {
    var s = new XMLHttpRequest;
    try {
        if (this.isFunction(this.runtime.send_request_response[e])) if (this.runtime.send_request_response[e](e, i, r)) return;
        ...
        }), this.isObject(o) && Object.keys(o).forEach(function (t) {
            s[t] = o[t]
        }), s.send(i)
    } catch (t) {
        this.isFunction(r) && r(t, 0, s, e)
    }
    ...
    if (e.isEmpty(e.runtime.current_element_mouse_down_gallery_view) || (i = document.querySelector('[data-runtime-id="' + e.runtime.current_element_mouse_down_gallery_view + '"]')).querySelectorAll(".ladi-gallery-view-item.selected").length > 0 && i.querySelectorAll(".ladi-gallery-view-item.selected")[0].style.removeProperty("left"), !e.isEmpty(e.runtime.current_element_mouse_down_gallery_control)) if ((i = document.querySelector('[data-runtime-id="' + e.runtime.current_element_mouse_down_gallery_control + '"]')).getElementsByClassName("ladi-gallery-control-box")[0].removeAttribute("data-left"), i.getElementsByClassName("ladi-gallery-control-box")[0].style.removeProperty("transition-duration"), i.getElementsByClassName("ladi-gallery-control-arrow-left")[0].classList.remove("opacity-0"), i.getElementsByClassName("ladi-gallery-control-arrow-right")[0].classList.remove("opacity-0"), i.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-top") || i.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-bottom")) {
        ...
        l = (l = -(l -= parseFloatLadiPage(getComputedStyle(i.getElementsByClassName("ladi-gallery-control")[0]).height) || 0)) > 0 ? 0 : l, s > 0 && (s = 0), s >= 0 && i.getElementsByClassName("ladi-gallery-control-arrow-left")[0].classList.add("opacity-0"), s <= l && i.getElementsByClassName("ladi-gallery-control-arrow-right")[0].classList.add("opacity-0")
    }
    ...
    if (e instanceof LadiPageScriptV2 || (e = LadiPageScript), e.runtime.isRun) {
        if (!e.isEmpty(e.runtime.eventData) && !e.runtime.tmp.is_run_show_popup) {
            for (var i = null, a = document.querySelectorAll('[data-popup-backdrop="true"]'), n = 0; n < a.length; n++) "none" != getComputedStyle(a[n]).display && (i = a[n].id);
            var o = [];
            if (!e.isEmpty(i)) for (var r = document.querySelectorAll("#" + i + " .ladi-element"), s = 0; s < r.length; s++) o.push(r[s].id);
            if (Object.keys(e.runtime.eventData).forEach(function (t) {
                var a = e.runtime.eventData[t], n = null, r = null, s = null,
                    l = Object.keys(e.runtime.list_scroll_func), d = [];
                d = "gallery" == a.type ? document.querySelectorAll("#" + t) : [s = document.getElementById(t)];
                for (var c = 0; c < d.length; c++) if (s = d[c], !e.isEmpty(s)) {
                    var p = "gallery" == a.type ? s.getAttribute("data-runtime-id") : s.getAttribute("id");
                    if (-1 != l.indexOf(p)) {
                        var u = !1;
                        "section" == a.type ? (n = s.offsetTop, (window.scrollY >= n && window.scrollY <= n + s.offsetHeight || window.scrollY + e.getHeightDevice() >= n && window.scrollY + e.getHeightDevice() <= n + s.offsetHeight || n >= window.scrollY && window.scrollY + e.getHeightDevice() >= n) && (u = !0)) : (n = e.getElementBoundingClientRect(s).y + window.scrollY, (window.scrollY >= n && window.scrollY <= n + s.offsetHeight || window.scrollY + e.getHeightDevice(!0) >= n && window.scrollY + e.getHeightDevice(!0) <= n + s.offsetHeight || n >= window.scrollY && window.scrollY + e.getHeightDevice(!0) >= n) && (u = !0)), u && (r = e.runtime.list_scroll_func[p], delete e.runtime.list_scroll_func[p], r())
                    }
                }
                ...
                if (!e.isEmpty(m) && (s = document.getElementById(t), !e.isEmpty(s) && !s.classList.contains("ladi-animation"))) {
                    ...
                    e.runtime.tmp.isFirstScroll && _ > 0 && !y && s.classList.add("ladi-animation-hidden"), y && (s.classList.add("ladi-animation"), e.runTimeout(function () {
                        s.classList.remove("ladi-animation-hidden")
                    }, 1e3 * _))
                }
                if (e.isEmpty(i) || -1 != o.indexOf(t)) {
                    var g = null, f = null, h = null;
                    if (a[e.runtime.device + ".option.sticky"] && (g = a[e.runtime.device + ".option.sticky_position"], f = parseFloatLadiPage(a[e.runtime.device + ".option.sticky_position_top"]), h = parseFloatLadiPage(a[e.runtime.device + ".option.sticky_position_bottom"])), !e.runtime.has_popupx && !e.isEmpty(g)) {
                        ...
                        if (!e.isEmpty(v) && v.clientWidth > 0 && v.clientHeight > 0 && -1 != ["default", "top", "bottom"].indexOf(g)) {
                            var E = e.getElementBoundingClientRect(v), P = v.getAttribute("data-top"),
                            ...
                            var A = null, b = null;
                            if ("default" == g && (f > P - window.scrollY ? (A = f + "px", b = L + "px") : e.getHeightDevice() - h - v.clientHeight < P - window.scrollY && (A = "calc(100% - " + (h + v.clientHeight) + "px)", b = L + "px")), "top" == g && (f > P - window.scrollY || e.getHeightDevice() - 0 < P - window.scrollY) && (A = f + "px", b = L + "px"), "bottom" == g && (e.getHeightDevice() - h - v.clientHeight < P - window.scrollY || 0 > P + v.clientHeight - window.scrollY) && (A = "calc(100% - " + (h + v.clientHeight) + "px)", b = L + "px"), e.isEmpty(A) || e.isEmpty(b)) v.style.removeProperty("top"), v.style.removeProperty("left"), v.style.removeProperty("width"), v.style.removeProperty("position"), v.style.removeProperty("z-index"); else if (v.style.setProperty("top", A), v.style.setProperty("left", b), "section" == a.type && (e.runtime.is_mobile_only ? v.style.setProperty("width", document.getElementsByClassName("ladi-wraper")[0].clientWidth + "px") : e.runtime.isDesktop && v.style.setProperty("width", "100%")), v.style.setProperty("position", "fixed"), v.style.setProperty("z-index", "90000050"), !v.hasAttribute("data-sticky")) {
            ...
            if (e.runtime.tmp.isFirstScroll = !1, !e.isEmpty(t)) {
                var c = 0, p = Object.values(e.runtime.list_scrolling_exec);
                if (e.isEmpty(e.runtime.tmp.timeout_scrolling_id)) for (c = 0; c < p.length; c++) p[c]();
    ...
    if (this.isEmpty(t)) for (p = 0; p < r.length; p++) c.push(r[p].id); else c.push(t);
    if (c.forEach(function (t) {
        ...
        if (!o.isEmpty(i)) {
            ...
            o.removeTimeout(a), i.removeAttribute("data-timeout-id"), a = parseFloatLadiPage(i.getAttribute("data-timeout-id-2")) || null, o.removeTimeout(a), i.removeAttribute("data-timeout-id-2");
            var n = i.getElementsByClassName("popup-close")[0];
            if (o.isEmpty(n) || (a = parseFloatLadiPage(n.getAttribute("data-timeout-id")) || null, o.removeTimeout(a), n.removeAttribute("data-timeout-id")), o.pauseAllVideo(i), o.isEmpty(i.style.getPropertyValue("display")) || (s = !0), i.style.removeProperty("display"), i.style.removeProperty("z-index"), i.hasAttribute("data-popup-backdrop")) {
                d(), e && (o.isEmpty(o.runtime.tmp.bodyScrollY) || window.scrollTo(0, o.runtime.tmp.bodyScrollY)), o.runtime.tmp.bodyScrollY = null;
                for (var c = 0; c < r.length; c++) r[c].style.removeProperty("z-index")
            }
    ...
    var r = this;
    if (!r.isEmpty(e)) {
        var s = document.getElementById(e), l = null;
        if (!n || !r.isEmpty(s) && r.isObject(r.runtime.eventData) && !r.isEmpty(r.runtime.eventData[e])) {
            r.runtime.tmp.is_run_show_popup = !0;
            var d = 0, c = "";
            n || LadiPagePlugin.getPlugin("popup").showStyleShowPopupBuilder(e), n && (i = r.runtime.eventData[e][r.runtime.device + ".option.popup_position"], a = r.runtime.eventData[e][r.runtime.device + ".option.popup_backdrop"]);
            r.isEmpty(a) ? c += "#" + r.runtime.backdrop_popup_id + " { display: none !important;}" : (c += "#" + r.runtime.backdrop_popup_id + " { display: block !important; " + a + "}", s.setAttribute("data-popup-backdrop", !0)), i == r.const.POSITION_TYPE.default && "true" != s.getAttribute("data-dropbox") && (!function () {
                if (!r.runtime.has_popupx && n) {
                    ...
                    "block" != s.style.getPropertyValue("display") || r.isEmpty(r.runtime.tmp.bodyScrollY) || (t = r.runtime.tmp.bodyScrollY), c += "body {", c += "position: fixed !important;", c += "width: 100% !important;", c += "top: -" + t + "px", c += "}", r.runtime.tmp.bodyScrollY = t, l = function () {
            ...
            if (r.isFunction(o) && !p && (o(), r.isFunction(l) && l()), r.isArray(r.runtime.list_show_popup_func[e])) for (; r.runtime.list_show_popup_func[e].length > 0;) {
                r.runtime.list_show_popup_func[e].shift()()
            }
            var u = s.hasAttribute("data-scroll"), m = s.hasAttribute("data-fixed-close"), _ = !1,
                y = s.getElementsByClassName("ladi-popup")[0],
                g = 1e3 * (parseFloatLadiPage(getComputedStyle(y).animationDuration) || 0),
                f = 1e3 * (parseFloatLadiPage(getComputedStyle(y).animationDelay) || 0),
                h = parseFloatLadiPage(s.getAttribute("data-timeout-id")) || null;
            r.removeTimeout(h), h = parseFloatLadiPage(s.getAttribute("data-timeout-id-2")) || null, r.removeTimeout(h), s.classList.add("ladi-animation-hidden"), "block" != getComputedStyle(s).display && s.style.setProperty("display", "block", "important"), h = r.runTimeout(function () {
                s.classList.remove("ladi-animation-hidden"), s.removeAttribute("data-timeout-id")
            }, f), r.isEmpty(h) || s.setAttribute("data-timeout-id", h), t && (!u && s.clientHeight > .8 * r.getHeightDevice() && (n ? r.runtime.has_popupx ? _ = !0 : (s.setAttribute("data-scroll", !0), s.style.setProperty("overflow-y", "auto", "important"), s.style.setProperty("overflow-x", "hidden", "important"), u = !0) : m = !0), r.runtime.has_popupx && (_ ? (s.setAttribute("data-fixed-close", !0), document.body.style.setProperty("height", s.clientHeight + "px")) : document.body.style.removeProperty("height")), u && n && (s.getElementsByClassName("ladi-popup")[0].style.removeProperty("height"), s.style.removeProperty("max-height"), s.getElementsByClassName("ladi-popup")[0].style.setProperty("height", s.clientHeight + "px", "important"), s.style.setProperty("max-height", "80vh"))), !n && m && LadiPagePlugin.getPlugin("popup").styleShowPopupBuilderScroll(e), r.runtime.has_popupx && (c += "#" + r.runtime.backdrop_popup_id + " { display: none !important;}", s.style.removeProperty("max-height"), s.style.removeProperty("overflow-y"), s.style.removeProperty("overflow-x")), r.isEmpty(c) || r.createStyleElement("style_popup", c);
            var v = null;
            if (n && !r.isEmpty(s) && "true" != s.getAttribute("data-dropbox")) {
                var E = s.getElementsByClassName("popup-close")[0];
                r.isEmpty(E) && ((E = document.createElement("div")).className = "popup-close", s.appendChild(E), E.addEventListener("click", function (t) {
                    t.stopPropagation(), r.runRemovePopup(e, n)
                })), h = parseFloatLadiPage(E.getAttribute("data-timeout-id")) || null, r.removeTimeout(h), E.classList.add("opacity-0"), r.runtime.has_popupx && r.runtime.tmp.popupx_is_inline && E.classList.add("ladi-hidden");
                var P = function () {
                    var t = s.getElementsByClassName("popup-close")[0];
                    if (!r.isEmpty(t)) {
                        var e = r.getElementBoundingClientRect(s), i = e.y, a = window.innerWidth - e.x - e.width;
                        (u || _) && (a += r.runtime.widthScrollBar), t.style.setProperty("right", a + "px"), t.style.setProperty("top", i + "px"), t.style.setProperty("position", "fixed")
                    }
                };
                v = function () {
                    h = r.runTimeout(function () {
                        P(), E.classList.remove("opacity-0"), E.removeAttribute("data-timeout-id")
                    }, g + f + 100), E.setAttribute("data-timeout-id", h)
                }, (u || _) && (s.hasAttribute("data-resize-scroll") || (s.setAttribute("data-resize-scroll", !0), window.addEventListener("resize", P)))
            }
            n && !p && r.runEventTracking(e, !1);
            var L = function () {
                h = r.runTimeout(function () {
                    delete r.runtime.tmp.is_run_show_popup, r.runEventScroll(), r.isFunction(v) && v(), s.removeAttribute("data-timeout-id-2")
                }, d), r.isEmpty(h) || s.setAttribute("data-timeout-id-2", h)
            };
            if (t) L(); else {
                h = r.runTimeout(function () {
                    "none" == getComputedStyle(s).display ? (d -= 100, L()) : r.runShowPopup(!0, e, i, a, n, o), s.removeAttribute("data-timeout-id-2")
                }, 100), s.setAttribute("data-timeout-id-2", h)
            }
        }
    }
    ...
    if (this.runtime.isClient && !this.isEmpty(t)) {
        var r = o.runtime.eventData[t], s = r.type, l = null, d = null, c = null, p = null, u = null,
        ...
        var _ = function (t) {
            if (!o.isEmpty(l)) {
                var a = "trackCustom";
                -1 != ["AddPaymentInfo", "AddToCart", "AddToWishlist", "CompleteRegistration", "Contact", "CustomizeProduct", "Donate", "FindLocation", "InitiateCheckout", "Lead", "PageView", "Purchase", "Schedule", "Search", "StartTrial", "SubmitApplication", "Subscribe", "ViewContent"].indexOf(l) && (a = "track");
                var n = null, r = null;
                if (o.isEmpty(u) || o.isEmpty(m) || ((n = {}).value = u, n.currency = m), t) o.runtime.tmp.runActionPopupX({
                    fbq_track_name: a,
                    conversion_name: l,
                    fbq_data: n,
                    fbq_event_data: r,
                    ...
                    if (o.isObject(window.ladi_conversion_api) && o.isObject(window.ladi_conversion_api.facebook) && o.isArray(window.ladi_conversion_api.facebook.pixels)) {
                        r = {eventID: "ladi." + Date.now() + "." + (Math.floor(9e10 * Math.random()) + 1e10)}
                    }
                ...
                o.isObject(i) && (o.isObject(r) || (r = {}), r.email = i.email, r.phone = i.phone), t ? o.runtime.tmp.runActionPopupX({
                    type: "facebook",
                    key: "events",
                    keyData: [{key: a, name: l, custom_data: n, data: r}],
                    action: {type: "run_conversion_api"}
                }) : o.runConversionApi("facebook", "events", [{key: a, name: l, custom_data: n, data: r}])
            }
        }, y = function (t) {
            if (o.isEmpty(d) || o.isEmpty(c) || (t ? o.runtime.tmp.runActionPopupX({
                conversion_name: "conversion",
                gtag_data: {send_to: "AW-" + d + "/" + c},
                action: {type: "run_tracking_gtag"}
            }) : window.gtag("event", "conversion", {send_to: "AW-" + d + "/" + c})), !o.isEmpty(l)) {
                var e = "";
                ...
                if (!o.isEmpty(i)) {
                    ...
                    o.isFunction(a.getEventTrackingCategory) && (e = i(r, o.runtime.isClient).getEventTrackingCategory())
                }
                var n = {event_category: e, event_label: window.location.host + window.location.pathname};
        ...
        if (!o.isEmpty(a)) {
            var g = !1;
            return o.isEmpty(d) || o.isEmpty(c) || (g = !0), o.isEmpty(l) || (g = !0), o.isEmpty(p) || (g = !0), void (g && a.addEventListener("click", function (r) {
    ...
    if (Object.keys(n).forEach(function (t) {
        ...
        (i = i.trim()) == e && (e = t)
    }), a) return this.isEmpty(n[e]) ? e : n[e].format("").trim();
    ...
    if (!this.isEmpty(t) && 0 != e.length) {
        ...
        for (var r = this, s = function (t) {
            ...
            if (3 !== t.nodeType) r.highlightText(t, e, i, a); else if (s.test(t.textContent)) {
                var l = document.createDocumentFragment(), d = 0;
                t.textContent.replace(s, function (e, i) {
                    var n = document.createTextNode(t.textContent.slice(d, i)), o = null;
                    r.isFunction(a) ? o = a(e) : (o = document.createElement("span")).textContent = e, l.appendChild(n), l.appendChild(o), d = i + e.length
                });
    ...
    var r = this, s = r.runtime.replacePrefixStart, l = r.runtime.replacePrefixEnd;
    ...
    return u = u.unique(), r.highlightText(i, u, !0, function (t) {
        ...
        d.startsWith(t) && (d = d.replaceAll(t, window.location.protocol + "//www.facebook.com/"))
    }), d
    ...
    for (var u = o.querySelectorAll(".ladi-element .ladi-form-item-container [name]"), m = 0; m < u.length; m++) {
        var _ = null, y = null, g = !1, f = null, h = u[m].getAttribute("type");
        ...
        if (!this.isNull(_)) {
            if (y = this.isArray(_) ? _[0] : _, y = this.isNull(y) ? "" : y, y += "", "INPUT" == u[m].tagName) if ("checkbox" == h || "radio" == h) {
                var A = !1;
                if ("checkbox" == h) {
                    var b = _;
    ...
    var i = this, a = function (a) {
        ...
        try {
            ...
            var n = document.execCommand("paste"), o = t.value;
    ...
    (a.initEvent(e, !0, !0), this.isObject(i)) && Object.keys(i).forEach(function (t) {
        a[t] = i[t]
    });
    ...
    if (t.addEventListener("click", a), "ontouchstart" in window) {
        var n = 0, o = 0, r = i.getWidthDevice(), s = Math.max(1, Math.floor(.01 * r)), l = null;
    ...
    (n.type = "text/javascript", this.isFunction(i) && (a = i, i = e, e = null), i && (n.async = !0), this.isObject(e)) && Object.keys(e).forEach(function (t) {
    ...
    this.isEmpty(t) && ((t = document.createElement("div")).className = "ladi-loading", t.innerHTML = "<div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div>", document.body.appendChild(t))
    ...
    var e = this;
    e.isObject(t) && Object.keys(t).forEach(function (i) {
        t[i] = e.decodeValue(t[i])
    });
    if (e.isArray(t)) for (var i = 0; i < t.length; i++) t[i] = e.decodeValue(t[i]);
    ...
    if (e.runtime.isLoadHtmlGlobal) {
        ...
        e.runtime.isClient = t, e.runtime.timenow = window.ladi("_timenow").get_cookie(), e.isEmpty(e.runtime.timenow) ? (e.runtime.timenow = Date.now(), window.ladi("_timenow").set_cookie(e.runtime.timenow, 1)) : e.runtime.timenow = parseFloatLadiPage(e.runtime.timenow) || 0;
        try {
        ...
        try {
            ...
            s = JSON.parse(Base64.decode(s || Base64.encode("{}"))), Object.keys(s).forEach(function (t) {
        ...
        var l = function (t) {
            ...
            }, d = e.getURLSearchParams(null, null, !0), c = e.getURLSearchParams(window.location.search, null, !0),
            p = l(d), u = Object.keys(p), m = "";
        u.forEach(function (t) {
            if (t != e.const.TRACKING_NAME && t != e.const.ACCESS_KEY_NAME) {
                ...
                (e.isArray(c[t]) ? c[t] : [c[t]]).forEach(function (i) {
                    e.isEmpty(m) ? m += "?" : m += "&", m += t + "=" + encodeURIComponent(i)
                })
            }
        }), window.ladi(e.const.TRACKING_NAME).delete_cookie("/"), e.historyReplaceState(window.location.pathname + m + window.location.hash);
        var _ = c[e.const.REF_NAME];
        e.isEmpty(_) ? _ = window.ladi("ladi_ref").get_cookie() : window.ladi("ladi_ref").set_cookie(_, 90, "/", window.location.host);
        var y = Object.keys(e.runtime.eventData), g = [], f = window.ladi("LADI_CLIENT_ID").get_cookie(),
            h = parseFloatLadiPage(window.ladi("LADI_PAGE_VIEW").get_cookie()) || 0,
            v = parseFloatLadiPage(window.ladi("LADI_FORM_SUBMIT").get_cookie()) || 0,
            E = window.ladi("LADI_FUNNEL_NEXT_URL").get_cookie(), P = window.ladi("LADI_CAMP_ID").get_cookie(),
            L = window.ladi("LADI_CAMP_NAME").get_cookie(), A = window.ladi("LADI_CAMP_TYPE").get_cookie(),
            b = window.ladi("LADI_CAMP_TARGET_URL").get_cookie(), w = window.ladi("LADI_CAMP_ORIGIN_URL").get_cookie(),
            S = parseFloatLadiPage(window.ladi("LADI_CAMP_PAGE_VIEW").get_cookie()) || 0,
            T = parseFloatLadiPage(window.ladi("LADI_CAMP_FORM_SUBMIT").get_cookie()) || 0,
            O = window.ladi("LADI_CAMP_CONFIG").get_cookie(), C = function (t, i, a) {
                if ("FormSubmit" == t && e.isEmpty(f)) e.isFunction(a) && a(); else if (!e.runtime.is_popupx || e.runtime.has_popupx) {
                    var n = e.runtime.publish_platform, o = e.runtime.store_id, r = e.runtime.time_zone,
                        s = window.location.host, l = window.location.href, d = e.runtime.ladipage_id, c = {
                            event: t,
                            pixel_id: o,
                            time_zone: r,
                            domain: s,
                ...
                var o = null, r = null, s = null, l = 0;
                if (e.isEmpty(i) || "POPUP_PRODUCT" != i.id) if (e.isEmpty(i) || "POPUP_BLOG" != i.id) e.isFunction(n) && n(); else {
                    ...
                    var d = function () {
                        ...
                        if (Object.keys(o.product).forEach(function (t) {
                            if (c && e.isString(o.product[t]) && o.product[t].startsWith("ladisources/global/dataset/") && o.product[t].endsWith(".html")) {
                                var i = o.product[t].replaceAll("ladisources/global/dataset/", e.const.API_DATASET_BLOG);
                            ...
                            for (l = 0; l < r.length; l++) for (var _ = r[l].querySelectorAll(".ladi-headline img, .ladi-paragraph img"), y = 0; y < _.length; y++) m(_[y]);
                    ...
                    if (e.isEmpty(a["option.product_variant_id"])) {
                        ...
                        var c = e.findAncestor(t, "ladi-collection-item"), p = null;
                        if (e.isEmpty(c)) {
                            for (var u = document.querySelectorAll('[data-variant="true"] select[data-store-id="' + o.store_info.id + '"][data-product-id="' + o.product.product_id + '"]'), m = 0; m < u.length; m++) if (e.isEmpty(e.findAncestor(u[m], "ladi-collection-item"))) {
                                p = u[m];
                                break
                            }
                ...
                n = -1 != n, i.forEach(function (i) {
                    if (i.action_type == e.const.ACTION_TYPE.complete) {
                        ...
                        if (i.type == e.const.DATA_ACTION_TYPE.section) {
                            var r = 0, s = document.getElementById(i.action);
                            if (!e.isEmpty(s)) {
                                ...
                                if (o = e.findAncestor(t, "ladi-popup"), !e.isEmpty(o)) {
                                    ...
                                    l.hasAttribute("data-popup-backdrop") && (window.ladi(l.id).hide(), r = 100)
                                }
                        ...
                        if (i.type == e.const.DATA_ACTION_TYPE.popup && (o = document.getElementById(i.action), e.isEmpty(o) || N(t, o, a, function () {
                            ...
                            var d = window.ladi(i.action);
                            e.isFunction(d[i.change_index_type]) ? d[i.change_index_type]() : d.index(i.change_index_number || 1)
                        }
                    }
                })
            }, k = function (t, i, a, n, o) {
                if (t = t || document.getElementById(i), !e.isEmpty(t)) {
                    var r = function (t) {
                        ...
                        return !0
                    }, l = n["option.is_submit_form"], d = n["option.data_submit_form_id"];
                    if (!n["option.action_funnel"] || e.isEmpty(E)) if (!l || e.isEmpty(d)) {
                            ...
                            if (a.action_type == e.const.ACTION_TYPE.action) {
                                if (a.type == e.const.DATA_ACTION_TYPE.link) {
                                    ...
                                    t.addEventListener("click", function (i) {
                                        s(t, i) && "true" == t.getAttribute("data-action") && (r = a.action, e.isEmpty(a.action_mapping) || (r = a.action_mapping), e.isEmpty(r) || (r = e.getLinkUTMRedirect(r, null), r = e.convertDataReplaceStr(r, !0), window.ladi(r).open_url(a.target, a.nofollow)))
                                    });
                                    var l = function () {
                                ...
                                if (a.type == e.const.DATA_ACTION_TYPE.email && t.addEventListener("click", function (i) {
                                    s(t, i) && ("true" != t.getAttribute("data-action") || e.isEmpty(a.action) || window.ladi("mailto:" + a.action).open_url())
                                }), a.type == e.const.DATA_ACTION_TYPE.phone && t.addEventListener("click", function (i) {
                                    s(t, i) && ("true" != t.getAttribute("data-action") || e.isEmpty(a.action) || window.ladi("tel:" + a.action).open_url())
                                    ...
                                    if (s(t, i)) {
                                        ...
                                        if (!e.isEmpty(o)) {
                                            if (m) return void window.ladi(o.id).scroll(!1, !0);
                                    ...
                                    if (s(t, i)) {
                                        var n = document.getElementById(a.action);
                                        e.isEmpty(n) || window.ladi(a.action).showDropbox(t, a.dropbox, !1)
                                    }
                                ...
                                a.type == e.const.DATA_ACTION_TYPE.set_value && t.addEventListener("click", function (i) {
                                    if (s(t, i)) {
                                        var n = window.ladi(a.action);
                                        e.isEmpty(n) || (a.is_clipboard ? e.getTextClipboard(a.str, function (t, e) {
                                            n.value(t ? e : a.str), u(t, !0)
                                        }) : n.value(a.str))
                                    }
                                }), a.type == e.const.DATA_ACTION_TYPE.copy_clipboard && t.addEventListener("click", function (i) {
                                    if (s(t, i)) {
                                        var n = null, o = window.ladi(a.action);
                                        e.isEmpty(o) || (n = o.value(null, null, {only_text: !0})), n = e.isEmpty(n) ? a.str : n, e.isEmpty(n) || e.copyTextClipboard(n, u)
                                    }
                                });
                                var c = null;
                                ...
                                c == e.const.DATA_ACTION_LIGHTBOX_TYPE.iframe && t.addEventListener("click", function (e) {
                                    ...
                                    s(t, i) && (e.runtime.shopping_third_party ? e.getThirdPartyCheckoutUrl(!0) : window.ladi("POPUP_CHECKOUT").show())
                                })
                            }
                        }), e.runEventTracking(i, !1, null, t, s)
                    } else t.addEventListener("click", function (e) {
                        s(t, e) && window.ladi(d).submit()
                    ...
                    if (!e.isEmpty(i) && "true" != i.getAttribute("data-action")) {
                        ...
                        !function (t, i) {
                            i.forEach(function (i) {
                                if (i.action_type == e.const.ACTION_TYPE.action && i.type == e.const.DATA_ACTION_TYPE.link) if (e.isEmpty(t.getAttribute("href"))) t.removeAttribute("href"); else {
                ...
                for (var t = document.querySelectorAll(".ladi-headline a[href], .ladi-paragraph a[href], .ladi-list-paragraph a[href]"), i = 0; i < t.length; i++) if (e.isEmpty(t[i].getAttribute("href"))) t[i].removeAttribute("href"); else {
                ...
                if (t) {
                    ...
                    }, a = !1, n = e.isArray(e.runtime.DOMAIN_FREE) ? e.runtime.DOMAIN_FREE : [], o = window.location.href;
                    ["/", ".", "/"].forEach(function (t) {
                            ...
                            e.isObject(o.data) ? (r = 1 == o.data.verified_domain, s = o.data.google_captcha) : r = 1 == o.data, a || r || e.runTimeout(i, 3e3), e.isObject(s) && function (t, i, a) {
                                if (!e.isEmpty(t)) {
                                    ...
                                    a.type == e.const.FORM_CONFIG_TYPE.google_recaptcha_enterprise && (i = !0), a.type == e.const.FORM_CONFIG_TYPE.google_recaptcha_checkbox && (n = !0), e.runtime.tmp.google_captcha = {
                                        ...
                                        for (var i = document.querySelectorAll(".ladi-form .ladi-button"), a = 0; a < i.length; a++) {
                                            var n = e.findAncestor(i[a], "ladi-element"), o = document.createElement("div");
                                            o.className = "ladi-google-recaptcha-checkbox", n.insertBefore(o, i[a]);
                                            var r = window.grecaptcha.render(o, {sitekey: t});
                                            o.setAttribute("data-widget-id", r)
                                        }
                                    }, i ? e.loadScript("//www.google.com/recaptcha/enterprise.js?render=" + t) : n ? e.loadScript("//www.google.com/recaptcha/api.js?onload=onloadRecaptchaCheckboxCallback&render=explicit") : e.loadScript("//www.google.com/recaptcha/api.js?render=" + t)
                                }
                ...
                if (e.isEmpty(e.runtime.current_element_mouse_down_gallery_view) && e.isEmpty(e.runtime.current_element_mouse_down_gallery_control)) {
                    ...
                    if (e.isEmpty(e.runtime.timeout_gallery[o]) && (!e.runtime.tmp.gallery_playing_video || !i)) {
                        ...
                        if (0 != r.length && 0 != r.length) {
                            ...
                            var u = 1e3 * (parseFloatLadiPage(getComputedStyle(r[d]).transitionDuration) || 0);
                            ...
                            if (t.getElementsByClassName("ladi-gallery-control-arrow-left")[0].classList.remove("opacity-0"), t.getElementsByClassName("ladi-gallery-control-arrow-right")[0].classList.remove("opacity-0"), t.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-top") || t.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-bottom")) {
                                var g = parseFloatLadiPage(getComputedStyle(t.getElementsByClassName("ladi-gallery-control")[0]).width) || 0,
                                    f = parseFloatLadiPage(getComputedStyle(t.getElementsByClassName("ladi-gallery-control-item")[d]).width) || 0,
                                    h = y.x - _.x - (g - f) / 2;
                                ...
                                var E = parseFloatLadiPage(getComputedStyle(t.getElementsByClassName("ladi-gallery-control")[0]).height) || 0,
                                    P = parseFloatLadiPage(getComputedStyle(t.getElementsByClassName("ladi-gallery-control-item")[d]).height) || 0,
                                    L = y.y - _.y - (E - P) / 2;
                                ...
                                L < (A = (A = -(A -= parseFloatLadiPage(getComputedStyle(t.getElementsByClassName("ladi-gallery-control")[0]).height) || 0)) > 0 ? 0 : A) && (L = A), t.getElementsByClassName("ladi-gallery-control-box")[0].style.setProperty("top", L + "px"), L >= 0 && t.getElementsByClassName("ladi-gallery-control-arrow-left")[0].classList.add("opacity-0"), L <= A && t.getElementsByClassName("ladi-gallery-control-arrow-right")[0].classList.add("opacity-0")
                            }
                ...
                var n = i.getAttribute("data-video-type"), o = i.getAttribute("data-video-url"),
                    r = i.getAttribute("data-index"), s = t.getAttribute("data-runtime-id") + "_" + r + "_player",
                ...
                if ("gallery" == n && (a || (i = document.getElementById(t)), !e.isEmpty(i))) {
                    ...
                    if (o > 0) {
                        for (var l = 0; l < o; l++) {
                            ...
                            e.isEmpty(d) || (s && Y(i, d, s), d.classList.contains("play-video") && d.addEventListener("click", r))
                        }
                ...
                t.stopPropagation();
                var a = e.runtime.eventData[i.id], n = a[e.runtime.device + ".option.gallery_control.autoplay"],
                    o = a[e.runtime.device + ".option.gallery_control.autoplay_time"], r = 0;
                n && !e.isEmpty(o) && (r = o);
                var s = parseFloatLadiPage(t.target.getAttribute("data-index")) || 0, l = null, d = null;
                (parseFloatLadiPage(i.getAttribute("data-current")) || 0) > s ? (l = "prev", d = "right") : (l = "next", d = "left");
                var c = i.getAttribute("data-is-next") || "true";
                (c = "true" == c.toLowerCase()) ? s-- : s++, i.setAttribute("data-current", s), i.setAttribute("data-next-time", Date.now() + 1e3 * r), M(i, !1, l, d)
            }, G = function () {
                y.forEach(function (t) {
                    var i = e.runtime.eventData[t];
                    if ("gallery" == i.type) for (var a = document.querySelectorAll("#" + t), n = 0; n < a.length; n++) {
                        ...
                        if ("true" == o.getAttribute("data-scrolled") && "true" != o.getAttribute("data-stop")) {
                            var r = i[e.runtime.device + ".option.gallery_control.autoplay"],
                                s = i[e.runtime.device + ".option.gallery_control.autoplay_time"], l = 0;
                            if (r && !e.isEmpty(s) && (l = s), l > 0) {
                                var d = o.getAttribute("data-next-time"), c = Date.now();
                                e.isEmpty(d) && (d = c + 1e3 * (l - 1), o.setAttribute("data-next-time", d)), c >= d && (M(o, !0), o.setAttribute("data-next-time", c + 1e3 * l))
                            }
                        }
                    }
                })
                ...
                if ("gallery" == a.type) {
                    ...
                    var o = a[e.runtime.device + ".option.gallery_control.autoplay"],
                        r = a[e.runtime.device + ".option.gallery_control.autoplay_time"], s = 0;
                    o && !e.isEmpty(r) && (s = r);
                    var l = function (t) {
                        H(t, i)
                    }, d = function (t) {
                    ...
                    i.getElementsByClassName("ladi-gallery-view-arrow-left")[0].addEventListener("click", function (t) {
                        t.stopPropagation(), i.setAttribute("data-is-next", !1), i.setAttribute("data-next-time", Date.now() + 1e3 * s), M(i, !1)
                        ...
                        t.stopPropagation(), i.setAttribute("data-is-next", !0), i.setAttribute("data-next-time", Date.now() + 1e3 * s), M(i, !1)
                        ...
                        if (!e.isEmpty(a)) {
                            ...
                            if (i.getElementsByClassName("ladi-gallery-control-arrow-left")[0].classList.remove("opacity-0"), i.getElementsByClassName("ladi-gallery-control-arrow-right")[0].classList.remove("opacity-0"), i.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-top") || i.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-bottom")) {
                                ...
                                var r = parseFloatLadiPage(getComputedStyle(i.getElementsByClassName("ladi-gallery-control-box")[0]).width) || 0;
                                r = (r = -(r -= parseFloatLadiPage(getComputedStyle(i.getElementsByClassName("ladi-gallery-control")[0]).width) || 0)) > 0 ? 0 : r, o > 0 && (o = 0), i.getElementsByClassName("ladi-gallery-control-box")[0].style.setProperty("left", o + "px"), o >= 0 && i.getElementsByClassName("ladi-gallery-control-arrow-left")[0].classList.add("opacity-0"), o <= r && i.getElementsByClassName("ladi-gallery-control-arrow-right")[0].classList.add("opacity-0")
                            } else {
                                ...
                                d = (d = -(d -= parseFloatLadiPage(getComputedStyle(i.getElementsByClassName("ladi-gallery-control")[0]).height) || 0)) > 0 ? 0 : d, l > 0 && (l = 0), i.getElementsByClassName("ladi-gallery-control-box")[0].style.setProperty("top", l + "px"), l >= 0 && i.getElementsByClassName("ladi-gallery-control-arrow-left")[0].classList.add("opacity-0"), l <= d && i.getElementsByClassName("ladi-gallery-control-arrow-right")[0].classList.add("opacity-0")
                            }
                        ...
                        if (!e.isEmpty(a)) {
                            ...
                            if (i.getElementsByClassName("ladi-gallery-control-arrow-left")[0].classList.remove("opacity-0"), i.getElementsByClassName("ladi-gallery-control-arrow-right")[0].classList.remove("opacity-0"), i.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-top") || i.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-bottom")) {
                                ...
                                var r = parseFloatLadiPage(getComputedStyle(i.getElementsByClassName("ladi-gallery-control-box")[0]).width) || 0;
                                o < (r = (r = -(r -= parseFloatLadiPage(getComputedStyle(i.getElementsByClassName("ladi-gallery-control")[0]).width) || 0)) > 0 ? 0 : r) && (o = r), i.getElementsByClassName("ladi-gallery-control-box")[0].style.setProperty("left", o + "px"), o >= 0 && i.getElementsByClassName("ladi-gallery-control-arrow-left")[0].classList.add("opacity-0"), o <= r && i.getElementsByClassName("ladi-gallery-control-arrow-right")[0].classList.add("opacity-0")
                            } else {
                                var l = (parseFloatLadiPage(n.height) || 0) + (parseFloatLadiPage(n.marginBottom) || 0);
                                l = -l + (parseFloatLadiPage(i.getElementsByClassName("ladi-gallery-control-box")[0].style.getPropertyValue("top")) || 0);
                                var d = parseFloatLadiPage(getComputedStyle(i.getElementsByClassName("ladi-gallery-control-box")[0]).height) || 0;
                                l < (d = (d = -(d -= parseFloatLadiPage(getComputedStyle(i.getElementsByClassName("ladi-gallery-control")[0]).height) || 0)) > 0 ? 0 : d) && (l = d), i.getElementsByClassName("ladi-gallery-control-box")[0].style.setProperty("top", l + "px"), l >= 0 && i.getElementsByClassName("ladi-gallery-control-arrow-left")[0].classList.add("opacity-0"), l <= d && i.getElementsByClassName("ladi-gallery-control-arrow-right")[0].classList.add("opacity-0")
                            }
                            i.setAttribute("data-next-time", Date.now() + 1e3 * s)
                        }
                ...
                if ((e.isEmpty(e.runtime.timenext_carousel[t]) || !(e.runtime.timenext_carousel[t] > Date.now())) && e.isEmpty(e.runtime.current_element_mouse_down_carousel)) {
                    ...
                    if (!e.isEmpty(a)) {
                        ...
                        var d = 1e3 * (parseFloatLadiPage(getComputedStyle(a.getElementsByClassName("ladi-carousel-content")[0]).transitionDuration) || 0);
                        e.runtime.timenext_carousel[t] = Date.now() + d;
                        var c = e.getElementBoundingClientRect(a), p = c.x + o * s - c.x - (a.clientWidth - s) / 2;
                        p = -p > 0 ? 0 : -p;
                ...
                var i, a = document.getElementsByClassName("ladi-form"), n = null, o = null, r = null, s = null, c = null,
                    p = null, u = null, m = null, y = null, g = null, f = null, h = null, v = null, P = null,
                    L = e.runtime.shopping, A = null,
                    w = ["utm_source", "utm_medium", "utm_campaign", "utm_term", "utm_content"],
                    S = ["name", "email", "phone", "address", "ward", "district", "state", "country"],
                    T = ["email", "phone"], N = e.copy(e.runtime.list_set_value_name_country).reverse(),
                    k = function (t, i) {
                        ...
                        var r = !0, s = 0, l = function () {
                            var i = t.querySelector('[name="' + P[s].name + '"]');
                            e.isEmpty(i) || i.focus()
                        };
                        for (s = 0; s < P.length; s++) if (!i || P[s].name == a) {
                            var d = n[P[s].name];
                            if (!e.isEmpty(d)) try {
                                if (!new RegExp("^" + P[s].pattern + "$", P[s].pattern_flag).test(d)) {
                        ...
                        var m = Object.keys(d).sort(function (t, e) {
                            return d[t] - d[e]
                        });
                        if (m.only(e.runtime.list_set_value_name_country).length == e.runtime.list_set_value_name_country.length) for (var _ = 0; _ < m.length; _++) {
                        ...
                        for (var f = 0; f < a.length; f++) {
                            ...
                            if ("INPUT" == a[f].tagName) {
                                ...
                                var E = a[f].getAttribute("pattern"), L = a[f].getAttribute("title");
                                if ("email" == h ? P.push({
                                    name: c,
                            ...
                            if (n[c] = a[f].value, a[f].classList.contains("ladi-form-control-file") && (n[c] = JSON.parse(a[f].getAttribute("data-path-file") || "[]"), r[c] = !0), "coupon" == c && "INPUT" == a[f].tagName && "text" == h && "true" == a[f].getAttribute("data-replace-coupon") && (n[c] = e.runtime.tmp.current_use_coupon || ""), "INPUT" == a[f].tagName && "date" == h && !e.isEmpty(n[c])) {
                                var A = a[f].getAttribute("date-format") || "dd-mm-yyyy", b = new Date(n[c]);
                                A = (A = (A = (A = A.replaceAll("dd", (b.getDate() < 10 ? "0" : "") + b.getDate())).replaceAll("mm", (b.getMonth() + 1 < 10 ? "0" : "") + (b.getMonth() + 1))).replaceAll("yyyy", b.getFullYear())).replaceAll("yy", b.getFullYear() - 2e3), n[c] = A
                            }
                        }
                        i || S.forEach(function (t) {
                            e.isNull(n[t]) || (window.ladi("_ladipage_" + t).set_cookie(n[t], 365, "/", window.location.host), e.isArray(e.runtime.DOMAIN_SET_COOKIE) && e.runtime.DOMAIN_SET_COOKIE.forEach(function (e) {
                        ...
                        if (t) o.status_send = 1; else if (o.status_send = 2, L) {
                        ...
                        if (p.forEach(function (t) {
                            ...
                            var a = {name: t, value: i = -1 != l.indexOf(t) ? LadiFormApi[t] : i};
                            r[t] && (a.is_file = !0), o.form_data.push(a)
                        }), (l = l.except(p)).forEach(function (t) {
                        ...
                        o.tracking_form.push({
                            ...
                            var i = A[t];
                            i = e.isNull(i) ? "" : i, o.tracking_form.push({name: t, value: i})
                        }), o.tracking_form.push({
                            name: "variant_url",
                            value: b
                        }), o.tracking_form.push({
                        ...
                        }), e.isEmpty(_) || o.tracking_form.push({name: e.const.REF_NAME, value: _}), e.isFunction(a) && a(o)
                    }, F = function (t) {
                        t.reset();
                        ...
                        if (!e.isEmpty(o)) for (var r = document.querySelectorAll('.ladi-form [data-submit-form-id="' + o.id + '"]'), s = 0; s < r.length; s++) {
                        ...
                        if (s = {}, c = {}, p = [], v = [], P = [], D(t, a), x(t, a, o)) {
                            ...
                            var m = i["option.form_setting"], _ = Object.keys(l);
                            if ((m.mapping_form_id || []).forEach(function (t) {
                                var i = document.getElementById(t);
                                if (!e.isEmpty(i)) {
                                    if (a) {
                                    ...
                                    }), a) for (u = 0; u < s.length; u++) e.fireEvent(s[u], "focusout")
                                }
                            }), !a) {
                                ...
                                if (!e.isArray(y)) {
                                    ...
                                    if (y = [], e.isObject(g) && (g.type = g.event_type, g.value = g.event_value, g.is_hide_parent = g.event_is_hide_parent, g.change_index_type = g.event_change_index_type, g.change_index_number = g.event_change_index_number, !e.isEmpty(g.value))) {
                                        if (g.type != e.const.DATA_ACTION_TYPE.section && g.type != e.const.DATA_ACTION_TYPE.popup || y.push({
                                            ...
                                            var f = e.findAncestor(t, "ladi-popup"), h = e.findAncestor(t, "ladi-section"),
                                                E = null;
                                            e.isEmpty(f) ? e.isEmpty(h) || (E = h.id) : E = (f = e.findAncestor(f, "ladi-element")).id, e.isEmpty(E) || y.push({
                                                action_type: e.const.ACTION_TYPE.complete,
                        ...
                        A = e.getURLSearchParams(null, null, !1), n = {}, o = {}, r = {}, s = {}, c = {}, p = [], u = null, m = null, y = null, g = null, f = a.captcha_token, e.isObject(e.runtime.tmp.google_captcha) && (h = e.runtime.tmp.google_captcha.type), v = [], P = [], L = e.findAncestor(i, "ladi-popup"), e.isEmpty(L) ? L = !1 : (L = e.findAncestor(L, "ladi-element"), L = !e.isEmpty(L) && "POPUP_CHECKOUT" == L.id);
                        ...
                        if (!e.isEmpty(b)) {
                            ...
                            if (l) {
                                ...
                                return a.captcha && !e.isEmpty(S) && S["option.form_captcha"] && e.isObject(e.runtime.tmp.google_captcha) ? void (window.grecaptcha && (e.runtime.tmp.google_captcha.enterprise && window.grecaptcha.enterprise ? window.grecaptcha.enterprise.ready(function () {
                                    ...
                                    !e.isEmpty(e.runtime.tmp.capture_form_data_last[d + "_" + _]) && e.equals(e.runtime.tmp.capture_form_data_last[d + "_" + _], a) || (e.runtime.tmp.capture_form_data_last[d + "_" + _] = a, e.sendRequest("POST", e.const.API_FORM_DATA, JSON.stringify(t), !0, {"Content-Type": "application/json"}))
                                })
                            }
                            if (e.isEmpty(S)) q(b, d); else if (e.isNull(e.runtime.tmp.form_sending) && (e.runtime.tmp.form_sending = {}), e.isNull(e.runtime.tmp.form_button_headline) && (e.runtime.tmp.form_button_headline = {}), !e.runtime.tmp.form_sending[i.id]) {
                                var T = function () {
                                    e.runtime.tmp.form_sending[i.id] = !0;
                                    var t = b.querySelector(".ladi-button > .ladi-element > .ladi-headline");
                                    e.isNull(e.runtime.tmp.form_button_headline[i.id]) && (e.runtime.tmp.form_button_headline[i.id] = t.innerHTML), t.innerHTML = "â— â— â—"
                                }, O = function () {
                                    delete e.runtime.tmp.form_sending[i.id], b.querySelector(".ladi-button > .ladi-element > .ladi-headline").innerHTML = e.runtime.tmp.form_button_headline[i.id]
                                };
                                if (a.captcha && !e.isEmpty(S) && S["option.form_captcha"] && e.isObject(e.runtime.tmp.google_captcha)) if (window.grecaptcha) if (T(), e.runtime.tmp.google_captcha.enterprise && window.grecaptcha.enterprise) window.grecaptcha.enterprise.ready(function () {
                                    try {
                                        window.grecaptcha.enterprise.execute(e.runtime.tmp.google_captcha.api_key, {action: "submit"}).then(function (t) {
                                            O(), Y(i, {captcha_token: t}, l, d, _)
                                        }).catch(function () {
                                            B(), O()
                                        })
                                    } catch (t) {
                                    ...
                                    var N = i.getElementsByClassName("ladi-google-recaptcha-checkbox")[0].getAttribute("data-widget-id"),
                                        I = window.grecaptcha.getResponse(N);
                                    O(), Y(i, {captcha_token: I}, l, d, _)
                                } catch (t) {
                                    B(), O()
                                    ...
                                    var k = S["option.form_send_ladipage"], M = S["option.form_api_data"],
                                        V = S["option.thankyou_type"], H = S["option.thankyou_value"],
                                        G = S["option.deeplink_value"], j = S["option.form_auto_funnel"],
                                        U = S["option.form_thankyou_funnel"];
                                    if (e.isEmpty(u)) q(b, d); else if (D(b, l), x(b, l, _)) {
                                        var W = 0, z = 0, X = [], K = !1, J = !1, Z = !0, Q = function (t) {
                                            t && F(b), O()
                                        }, $ = function (t) {
                                            if (-1 != [e.const.FORM_CONFIG_TYPE.sapo, e.const.FORM_CONFIG_TYPE.shopify, e.const.FORM_CONFIG_TYPE.haravan, e.const.FORM_CONFIG_TYPE.wordpress].indexOf(e.runtime.shopping_product_type) && e.runtime.tmp.cart.length > 0) {
                                                ...
                                                return a = JSON.stringify(a), a = encodeURIComponent(a), void e.removeAddToCartProduct(a, !1, i, function (i) {
                                                    i ? $(t) : e.isFunction(t) && t()
                                                })
                                            }
                                            -1 != [e.const.FORM_CONFIG_TYPE.ladisales].indexOf(e.runtime.shopping_product_type) && (window.ladi("_cart_token").delete_cookie(), window.ladi("_checkout_token").delete_cookie(), e.createCartData()), e.isFunction(t) && t()
                                        }, tt = function (a, r, l, d) {
                                            if (l.readyState == XMLHttpRequest.DONE) {
                                                if (d == e.const.API_FORM_DATA) {
                                                    ...
                                                    200 == p.code ? W++ : (z++, Z = !1)
                                                } else 200 == r || 201 == r ? W++ : e.getElementAHref(d).host == e.const.DOMAIN_GOOGLE_DOCS ? W++ : z++;
                                                W + z == X.length && (Z && !K && W >= 1 ? (K = !0, o = e.copy(n), c = e.copy(s), Object.keys(e.runtime.replaceStr).forEach(function (t) {
                                                    ...
                                                    e.runEventTracking(i.id, !0, n), window.ladi("_capture_" + i.id).delete_cookie(), $(function () {
                                                        e.runTimeout(function () {
                                                            Q(!0), e.runtime.tmp.current_use_coupon = null, function () {
                                                                if (V != e.const.FORM_THANKYOU_TYPE.url) {
                                                                    var a = e.findAncestor(i, "ladi-popup");
                                                                    e.isEmpty(a) || (a = e.findAncestor(a, "ladi-element"), e.runRemovePopup(a.id, t))
                                                                }
                                                                var n = 0;
                                                                if (!e.runtime.isDesktop && !e.isEmpty(G)) {
                                                                    n = 1e3;
                                                                    var r = e.convertDataReplaceStr(G, !0, null, !1, c);
                                                                    window.ladi(r).open_url()
                                                                }
                                                                if (!U || e.isEmpty(E)) {
                                                                    if (V == e.const.FORM_THANKYOU_TYPE.default && (e.isEmpty(H) || e.showMessage(H, c)), V == e.const.FORM_THANKYOU_TYPE.popup && (j && e.setDataReplaceElement(!1, !1, c, H), window.ladi(H).show()), V == e.const.FORM_THANKYOU_TYPE.url && !e.isEmpty(H)) {
                                                                        var s = window.ladi(H).get_url(o, j, !1);
                                                                        e.runTimeout(function () {
                                                                            window.ladi(s).open_url()
                                                                        }, n)
                                                                    }
                                                                } else {
                                                                    var l = window.ladi(E).get_url(o, j, !1);
                                                                    e.runTimeout(function () {
                                                ...
                                                })) : !J && z >= 1 && (J = !0, e.showMessage(e.const.LANG.REQUEST_SEND_ERROR), Q(!1)))
                                            }
                                        }, et = function (t) {
                                            X.push({
                                        ...
                                        k && R(l, d, et), e.isArray(M) && M.forEach(function (t) {
                                            if (!e.isEmpty(t.api_url) && e.isArray(t.custom_fields)) {
                                                var i = e.getElementAHref(t.api_url).host == e.const.DOMAIN_GOOGLE_DOCS, a = {},
                                                    n = null, o = null, l = null, d = null;
                                                ...
                                                var u = null, m = t.content_type || e.const.CONTENT_TYPE.form_urlencoded;
                                                if (m == e.const.CONTENT_TYPE.form_urlencoded && (c["Content-Type"] = "application/x-www-form-urlencoded", u = Object.keys(a).reduce(function (t, e) {
                                                    return t.push(e + "=" + encodeURIComponent(a[e])), t
                                                }, []).join("&")), m == e.const.CONTENT_TYPE.json && (c["Content-Type"] = "application/json", u = JSON.stringify(a)), m == e.const.CONTENT_TYPE.form_data) u = new FormData, Object.keys(a).forEach(function (t) {
                                                    u.append(t, a[t])
                                                });
                                                X.push({url: t.api_url, data: u, async: !0, headers: c, callback: tt})
                                            }
                                        });
                                        X.length > 0 ? T() : k ? q(b, d) : (T(), R(l, d, et)), X.forEach(function (t) {
                        ...
                        var i = e.findAncestor(t.target, "ladi-element");
                        if (!e.isEmpty(i)) {
                            for (var a = i.querySelectorAll('[ladi-checkbox-required="true"]'), o = -1, r = 0; r < a.length; r++) if (0 == a[r].querySelectorAll('[type="checkbox"]:checked').length) {
                                o = r;
                                break
                            }
                            if (-1 == o) {
                                var l = null, d = e.runtime.eventData[i.id];
                                if (!e.isEmpty(d) && d["option.is_form_login"]) !function (t, i) {
                                    ...
                                    if (!e.isEmpty(a) && !e.isEmpty(a.value)) {
                                        for (var n = [], o = 0, r = 1; r <= 50; r++) {
                                            var s = window.ladi("_login_token_" + r).get_cookie();
                                        ...
                                        }), !0, {"Content-Type": "application/json"}, function (t, i, a, r) {
                                            if (a.readyState == XMLHttpRequest.DONE) {
                                                var s = {}, l = e.const.LANG.FORM_LOGIN_SEND_ERROR;
                                                try {
                                                    if (200 == (s = JSON.parse(t)).code) {
                                                        var d = n.findIndex(function (t) {
                                                            return t == s.data.token
                                                        });
                                                        -1 != d && (o = d + 1), window.ladi("_login_token_" + o).set_cookie(s.data.token, 7);
                                                        var c = e.getElementAHref(s.data.url, !0), p = window.location.search;
                                                        return (p.startsWith("?") || p.startsWith("&")) && (p = p.substring(1)), e.isEmpty(p) || (c.search = c.search + (e.isEmpty(c.search) ? "?" : "&") + p), void window.ladi(c.href).open_url()
                                                    }
                                                    l = s.message || l
                                                } catch (t) {
                                                }
                                ...
                                }(i); else if (!e.isEmpty(d) && e.isObject(d["option.form_setting"]) && d["option.form_setting"].is_multiple) M(i, d, !1); else {
                                    if (e.runtime.shopping_product_type == e.const.FORM_CONFIG_TYPE.ladisales && !e.isNull(e.runtime.shopping_config_checkout_id)) {
                                        ...
                                        if (!e.isEmpty(u) && (u = e.findAncestor(u, "ladi-element"), !e.isEmpty(u) && "POPUP_CHECKOUT" == u.id)) return function (t) {
                                            ...
                                            s = {}, c = {}, p = [], v = [], P = [], D(t, !1);
                                            var o = n.email, r = n.phone;
                                            if (e.isEmpty(i) || e.isEmpty(a)) e.showMessage(e.const.LANG.FORM_INPUT_REQUIRED_ERROR); else if (e.isEmpty(o) && e.isEmpty(r)) e.showMessage(e.const.LANG.FORM_INPUT_REQUIRED_ERROR); else {
                                                var l = (A = e.getURLSearchParams(null, null, !1)).utm_source, d = A.utm_medium,
                                                    u = A.utm_campaign, m = A.utm_term, y = A.utm_content, g = n.name,
                                                    f = n.address, h = n.message, E = n.country || "";
                                                E = E.split(":")[0];
                                                var L = n.state || "";
                                                L = L.split(":")[0];
                                                var b = n.district || "";
                                                ...
                                                var w = n.ward || "";
                                                w = w.split(":")[0];
                                                var S = n.coupon, T = e.runtime.tmp.add_to_cart_shipping_method_id,
                                                    O = e.getLadiSaleCheckoutCartProducts(), C = {
                                                        cart_token: i,
                                                        checkout_token: a,
                                                        discount_code: S,
                                    ...
                                    e.isEmpty(d) || !d["option.form_auto_capture"] || e.isEmpty(d["option.form_config_id"]) || (l = k(i.id, d["option.form_config_id"])), Y(i, {captcha: !0}, !1, l)
                                }
                            } else {
                        ...
                        if (!e.isEmpty(o)) {
                            ...
                            if (!(e.isEmpty(r) || (a = i ? a : e.runtime.eventData[r.id], e.isEmpty(a) || !a["option.is_buy_now"] && !a["option.is_add_to_cart"] || e.isEmpty(a["option.product_type"]) || e.isEmpty(a["option.product_id"])))) {
                                var s = function () {
                                    ...
                                    if (e.isEmpty(o) || e.isEmpty(o.store_info) || e.isEmpty(o.product)) e.isEmpty(e.runtime.tmp.timeout_product_info[a["option.product_type"]][a["option.product_id"]]) && e.showMessage(e.const.LANG.ADD_TO_CART_NO_PRODUCT, {name: e.getMessageNameProduct()}); else {
                                        var l = -1, d = null;
                                        if (i) {
                                        ...
                                        if (-1 != l) {
                                            ...
                                            var u = o.product.name, m = o.product.variants[l].title,
                                                _ = o.product.variants[l].price, y = o.product.variants[l].quantity,
                                            ...
                                            if (0 == o.product.select_many_service && e.isArray(e.runtime.tmp.cart) && -1 != e.runtime.tmp.cart.findIndex(function (t) {
                                            ...
                                            })) e.showMessage(e.const.LANG.ADD_TO_CART_PRODUCT_ONLY_ONE, {name: e.getMessageNameProduct(o.product.variants[l])}); else {
                                                var h = e.runtime.tmp.cart.findIndex(function (t) {
                                                    return t.product_variant_id == d
                                                }), v = !1;
                                                -1 == h && (v = !0, e.runtime.tmp.cart.push({
                                                ...
                                                if (e.isEmpty(E) || e.isEmpty(E.value)) e.showMessage(e.const.LANG.ADD_TO_CART_QUANTITY_REQUIRED); else {
                                                    ...
                                                    if (!e.isEmpty(b) && e.runtime.tmp.cart[h].quantity + P > b && (P = b - e.runtime.tmp.cart[h].quantity) <= 0 && (w = !0, L = b), 1 == o.product.variants[l].inventory_checked) {
                                                        if (A > y) return void e.showMessage(e.const.LANG.ADD_TO_CART_NO_QUANTITY, {name: e.getMessageNameProduct(o.product.variants[l], !0)});
                                                    ...
                                                    if (w || P <= 0 && y > 0) e.showMessage(e.const.LANG.ADD_TO_CART_MAX_QUANTITY, {
                                                        ...
                                                        var S = !e.isEmpty(o.product.variants[l].start_date) && new Date(o.product.variants[l].start_date).getTime() > Date.now(),
                                                            T = !e.isEmpty(o.product.variants[l].end_date) && new Date(o.product.variants[l].end_date).getTime() < Date.now();
                                                        if (S) e.showMessage(e.const.LANG.ADD_TO_CART_PRODUCT_BEFORE_START_DATE, {name: e.getMessageNameProduct(o.product.variants[l])}); else if (T) e.showMessage(e.const.LANG.ADD_TO_CART_PRODUCT_AFTER_END_DATE, {name: e.getMessageNameProduct(o.product.variants[l])}); else {
                                                            var O = function () {
                                                                e.runtime.tmp.cart[h].quantity += P;
                                                                var t = {product_id: p, product_variant_id: d, quantity: P};
                                                            ...
                                                            if (e.isEmpty(window.ladi("_cart_token").get_cookie())) if (e.runtime.tmp.is_click_add_to_cart) {
                                                                var C = function () {
                                                                    e.runTimeout(function () {
                                                                ...
                                                                C()
                                                            } else e.runtime.tmp.is_click_add_to_cart = !0, O(); else O()
                                                        }
                                                    } else y <= 0 && e.showMessage(e.const.LANG.ADD_TO_CART_NO_QUANTITY, {name: e.getMessageNameProduct(o.product.variants[l], !0)})
                                                }
                                            }
                                        } else e.showMessage(e.const.LANG.ADD_TO_CART_PRODUCT_REQUIRED, {name: e.getMessageNameProduct(o.product.variants[l])})
                                    }
                                };
                                s()
                            }
                            ...
                            if (!e.isEmpty(a)) {
                                ...
                                n.forEach(function (t) {
                                    if (t.action_type == e.const.ACTION_TYPE.action) {
                                        var i = null;
                                        t.type == e.const.DATA_ACTION_TYPE.popup_cart && (i = "POPUP_CART"), t.type == e.const.DATA_ACTION_TYPE.popup_checkout && (i = "POPUP_CHECKOUT"), t.type == e.const.DATA_ACTION_TYPE.popup_checkout && e.runtime.shopping_third_party ? e.getThirdPartyCheckoutUrl(!0) : e.isEmpty(i) || window.ladi(i).show()
                                    }
                        ...
                        if (!e.isEmpty(i)) {
                            ...
                            if (!e.isEmpty(a)) {
                                ...
                                if (!e.isEmpty(n)) if (e.isObject(n["option.form_setting"]) && n["option.form_setting"].is_multiple) M(a, n, !0, t.target.getAttribute("name")); else if (n["option.form_auto_capture"] && !e.isEmpty(n["option.form_config_id"])) {
                                    var o = k(a.id, n["option.form_config_id"]);
                                    Y(a, {captcha: !0}, !0, o, t.target.getAttribute("name"))
                                }
                            }
                        }
                    }, z = {};
                S.forEach(function (t) {
                    z[t] = window.ladi("_ladipage_" + t).get_cookie(), e.isEmpty(d[t]) || (z[t] = d[t])
                }), i = l(z);
                var X = 0, K = !1, J = function (t) {
                    for (var n = a[X].querySelectorAll('.ladi-element .ladi-form-item-container [name="' + t + '"]'), o = 0; o < n.length; o++) {
                        var r = z[t];
                        if (!e.isEmpty(r)) if ("true" != n[o].getAttribute("data-is-select-country") && (r = i[t]), "SELECT" == n[o].tagName) n[o].querySelectorAll('option[value="' + r + '"]').length > 0 && (n[o].value = r, K && e.fireEvent(n[o], "change")); else {
                ...
                for (X = 0; X < a.length; X++) {
                    a[X].onsubmit = H;
                    for (var $ = e.findAncestor(a[X], "ladi-element"), tt = a[X].getElementsByClassName("ladi-button"), et = 0; et < tt.length; et++) {
                        var it = a[X].getElementsByClassName("ladi-button")[et];
                        if (!e.isEmpty(it)) {
                            var at = e.findAncestor(it, "ladi-element");
                            e.isEmpty($) || e.isEmpty(e.runtime.eventData[$.id]) || !e.runtime.eventData[$.id]["option.is_add_to_cart"] ? at.addEventListener("click", U) : (at.setAttribute("data-click", !1), at.addEventListener("click", j))
                        }
                    }
                    ...
                    for (var rt = a[X].querySelectorAll('input[data-type="date"]'), st = 0; st < rt.length; st++) e.isEmpty(rt[st].getAttribute("placeholder")) || (rt[st].setAttribute("type", "text"), rt[st].addEventListener("focus", Z), rt[st].addEventListener("blur", Q));
                    var lt = a[X].querySelectorAll("[tabindex]"), dt = 0;
                ...
                mt(e.copy(S).except(e.runtime.list_set_value_name_country));
                e.runtime.tmp.listAfterLocation.push(function () {
                    var t = "", i = "", n = "", o = "", r = null, s = function (t, e) {
                        var i = "" + r[t].name, a = "" + r[e].name;
                        try {
                        ...
                        if (!e.isEmpty(o)) {
                            ...
                            e.isEmpty(d) || (d.setAttribute("data-selected", ""), d.innerHTML = d.querySelector("option").outerHTML), e.reloadFeeShipping({target: d})
                        }
                    }, c = function (t) {
                        var i = e.findAncestor(t.target, "ladi-element");
                        if (!e.isEmpty(i)) {
                    ...
                    for (X = 0; X < a.length; X++) {
                        var u = a[X].querySelectorAll('.ladi-element .ladi-form-item-container [name="state"]'), m = 0,
                            _ = null;
                        for (m = 0; m < u.length; m++) if (_ = e.findAncestor(u[m], "ladi-element"), !e.isEmpty(_) && (i = e.runtime.eventData[_.id]["option.input_country"], !e.isEmpty(i) && (t = "", i = i.split(":")[0], !e.isEmpty(window.LadiLocation[i])))) {
                            var y = window.LadiLocation[i].data, g = Object.keys(y);
                            r = y, g.sort(s), "VN" == i && (g = g.except(["201", "202", "224", "220", "203"]), g = ["201", "202", "224", "220", "203"].concat(g)), g.forEach(l), u[m].innerHTML = u[m].querySelector("option").outerHTML + t, u[m].setAttribute("data-country", i), u[m].addEventListener("change", d)
                        }
                ...
                for (var t = document.querySelectorAll(".ladi-form .ladi-element .ladi-form-control-file"), i = function (t) {
                                            ...
                                            if (e.hideLoadingBlur(), 200 == a) try {
                                                ...
                                                if (200 == o.code) {
                                                    ...
                                                    return o.data.success.forEach(function (t) {
                                                        r.push(t.name), s.push({id: t._id, path: t.path, name: t.name})
                    ...
                    var n = t[a], o = e.findAncestor(n, "ladi-form");
                    o = e.findAncestor(o, "ladi-element");
                    var r = e.runtime.eventData[o.id];
                    !e.isEmpty(r) && r["option.form_send_ladipage"] && (n.readOnly = !0, n.style.setProperty("cursor", "pointer"), n.addEventListener("click", i))
                }
            }, X = function (t) {
                ...
                for (var n = 0; n < a.length; n++) {
                    K(a[n]) == i ? a[n].classList.add("selected") : a[n].classList.remove("selected")
                }
            }, Z = function (t) {
                    ...
                    if (!e.isEmpty(r) && r["option.is_add_to_cart"]) {
                        ...
                        if (!e.isEmpty(s) && (!n || e.isEmpty(e.findAncestor(s, "ladi-collection-item")))) {
                            ...
                            if (!e.isEmpty(l)) {
                                ...
                                if (!e.isEmpty(d)) {
                                    var c = r["option.product_type"], p = r["option.product_id"];
                                    if (!e.isEmpty(c) && !e.isEmpty(p)) {
                                        ...
                                        if (!(e.isEmpty(u) || e.isEmpty(u.store_info) || e.isEmpty(u.product))) {
                                            ...
                                            e.showParentVisibility(l, function () {
                                                ...
                                                for (o = 0; o < c.length; o++) n[c[o].getAttribute("data-store-id") + "_" + c[o].getAttribute("data-product-id") + "_" + c[o].getAttribute("data-product-option-id")] = Z(c[o]);
                                                l.innerHTML = m;
                                                ...
                                                for (f = 0; f < h.length; f++) {
                                                    ...
                                                    p = n[h[f].getAttribute("data-store-id") + "_" + h[f].getAttribute("data-product-id") + "_" + h[f].getAttribute("data-product-option-id")], e.isNull(p) && (u = v[1], e.isEmpty(u) || (p = K(u))), J(h[f], p)
                                                }
                ...
                if (e.isObject(a) && e.isObject(a.variant) && e.isObject(a.product)) {
                    ...
                    if (e.isEmpty(o) && (o = a.product.image, e.isObject(o) && (o = o.src)), !e.isEmpty(o)) {
                        ...
                        var r = e.findAncestor(i, "ladi-collection-item"), s = [], l = 0, d = null;
                        if (e.isEmpty(r)) {
                        ...
                        for (l = 0; l < s.length; l++) if (d = e.runtime.eventData[s[l].id], !e.isEmpty(d) && !e.isEmpty(d["option.product_mapping_name"])) {
                            ...
                            m = 'url("' + m + '")';
                            for (var _ = p.getElementsByClassName("ladi-gallery-view-item"), y = 0; y < _.length; y++) if (u == getComputedStyle(_[y]).backgroundImage || m == getComputedStyle(_[y]).backgroundImage) {
            ...
            }, et = function (i, a, n, o, r, s, l, d) {
                var c = e.runtime.eventData[i];
                if (!e.isEmpty(c)) {
                    var p = c["option.product_mapping_name"], u = !e.isEmpty(p), m = c.type, _ = JSON.stringify(c),
                        g = null, f = null;
                    if (s) g = r.product[p]; else if (e.isEmpty(o)) {
                        if (e.isEmpty(c) || e.isEmpty(c["option.product_type"]) || e.isEmpty(c["option.product_id"]) || e.isEmpty(p)) return;
                        var h = c["option.product_variant_id"], v = !1;
                        ...
                        if ("form" == m && c["option.is_add_to_cart"]) return c["option.product_id"] = o.product_id, c["option.product_variant_id"] = o.product_variant_id, void $(i, m, !1, !0);
                        if (!u) return;
                        g = (g = (f = e.generateProductKey(!0, null, !0, c, !1, o.product_variant_id, o)).value) || ""
                    }
                    var P = null, L = null, A = null;
                    ...
                    if ("gallery" == m) {
                        ...
                        if (P = document.getElementById(i), e.isEmpty(P)) return;
                        if (n && "true" == P.getAttribute("data-loaded")) return void tt(P, f, c);
                ...
                var a = e.runtime.eventData[t], n = document.getElementById(t), o = null, r = null, s = !1, l = !1,
                    d = {width_device: e.runtime.desktop_width}, c = document.getElementById("style_container_desktop");
                if ((e.isEmpty(c) || "print" == c.getAttribute("media")) && (d = {width_device: e.runtime.mobile_width}), !e.isEmpty(a) && !e.isEmpty(n)) {
                    var p = getComputedStyle(n);
                    if ("popup" == a.type) {
                        o = {}, s = (r = ot(t)).isCurrentPopup, l = r.isCurrentSection;
                        ...
                        }), window.ladi(t).show(!0), nt(t, i, s, l), !0
                    }
                    if ("section" == a.type) {
                        if (s = (r = ot(t)).isCurrentPopup, l = r.isCurrentSection, a[e.runtime.device + ".option.sticky"]) {
                            o = {height: p.height};
                            var _ = n.getElementsByClassName("ladi-container")[0], y = getComputedStyle(_);
                            at(y.width), d.width = y.width, d.is_sticky_bar = !0, it({
                                id: t,
                                data_scale: d,
                                dimension: o,
                                element: a,
                            ...
                            }), window.ladi(t).show(!0), nt(t, i, s, l)
                        }
                        return !0
                    }
                }
                ...
                if (!e.isEmpty(a) && !e.isEmpty(n)) {
                    var r = getComputedStyle(n), s = ot(t), l = s.isCurrentPopup, d = s.isCurrentSection,
                        c = {width_device: e.runtime.desktop_width}, p = document.getElementById("style_container_desktop");
                    if ((e.isEmpty(p) || "print" == p.getAttribute("media")) && (c = {width_device: e.runtime.mobile_width}), o = {
                        width: r.width,
                        height: r.height
                    }, "popup" == a.type && (c.width = o.width), "section" == a.type) {
                        var u = n.getElementsByClassName("ladi-container")[0], m = getComputedStyle(u);
                        o.width = m.width, c.width = m.width, c.is_sticky_bar = !0
                    }
                    return at(o.width), it({
                        id: t,
                        data_scale: c,
                        dimension: o,
                        action: {type: "set_iframe_dimension"}
                    }), window.ladi(t).show(!0), nt(t, i, l, d), !0
                }
                return !1
            }, lt = function (t) {
                ...
                e.changeTotalPriceCart(), e.runtime.tmp.generateLadiSaleProduct(!0), e.runtime.shopping && e.createCartData(), e.loadDataset(null, null, null, null, null, !0, t), y.forEach(function (i) {
                    var a, n, o = e.runtime.eventData[i], r = LadiPageApp[o.type + e.const.APP_RUNTIME_PREFIX];
                    e.isEmpty(r) ? (!function (t, i, a, n, o, r) {
                        var s = document.getElementById(t);
                        if (!e.isEmpty(s) && (D(t), "section" == i && !e.isEmpty(o) && !e.isEmpty(r))) {
                    ...
                    }(i, o.type, o[e.const.DESKTOP + ".option.background-style"], o[e.const.MOBILE + ".option.background-style"], o["option.background_video.video_type"], o["option.background_video.video_value"]), k(null, i, o.type, o), a = o.type, n = o["option.data_event"] || o["option.data_action"], e.runtime.list_loaded_func.push(function () {
                        var t = 0;
                        ...
                        e.runTimeout(function () {
                            n.forEach(function (t) {
                                t.action_type == e.const.ACTION_TYPE.action && (t.type != e.const.DATA_ACTION_TYPE.collapse || e.isEmpty(t.action) || !e.isNull(t.collapse_start_is_show) && t.collapse_start_is_show || window.ladi(t.action).collapse(!1))
                            })
                        }, t)
                    }), x(null, i, o.type, o["option.data_event"] || o["option.data_hover"]), function (t, i, a, n, o, r, s) {
                    ...
                    }(i, o.type, o["option.show_popup_welcome_page"], o["option.delay_popup_welcome_page"]), R(i, null, o.type, o["option.countdown_type"], o["option.countdown_minute"], o["option.countdown_daily_start"], o["option.countdown_daily_end"], o["option.countdown_endtime"]), F(i, null, o.type, o["option.countdown_item_type"]), function (t, i, a, n) {
                        if ("section" == i) {
                        ...
                        if ("form_item" == i) {
                            var n = null;
                            if (a == e.const.INPUT_TYPE.select || a == e.const.INPUT_TYPE.select_multiple) for (var o = document.getElementById(t).getElementsByClassName("ladi-form-control"), r = 0; r < o.length; r++) o[r].addEventListener("change", function (t) {
                            ...
                            if (a == e.const.INPUT_TYPE.checkbox) {
                                ...
                                for (var s = function (t) {
                                    ...
                                    n[d].getElementsByTagName("span")[0].addEventListener("click", l), c.addEventListener("change", s)
                                }
                            }
                    ...
                    }(i, o.type, o["option.input_type"]), V(i, null, !1, o.type), e.startAutoScroll(i, o.type, o[e.const.DESKTOP + ".option.auto_scroll"], o[e.const.MOBILE + ".option.auto_scroll"]), $(i, o.type, !0, !1), function (t, i) {
                        if ("form" == i) {
                            var a = document.getElementById(t);
                            if (!e.isEmpty(a)) {
                                ...
                                if (!e.isEmpty(n)) {
                                            ...
                                            if (!e.isEmpty(a) && a["option.is_add_to_cart"]) {
                                                ...
                                                if (!(e.isEmpty(n) || e.isEmpty(n.store_info) || e.isEmpty(n.product))) {
                                                    ...
                                                    if (-1 != r) {
                                                        ...
                                                        s = e.isNull(l) ? s : l;
                                                        var d = parseInt(i.target.value) || 0, c = 1;
                                                        c = n.product.variants[r].min_buy || c;
                                                        var p = n.product.variants[r].max_buy, u = 0,
                                    ...
                                    var r = a.querySelectorAll("button")[0], s = a.querySelectorAll("button")[1];
                        ...
                        if ("survey" == i) {
                            ...
                            if (!e.isEmpty(o)) {
                                ...
                                var r = o.getElementsByClassName("ladi-survey-option"),
                                    s = o.querySelector(".ladi-survey-button-next button"), l = [], d = n.mapping_form_name,
                                    c = n.mapping_form_id, p = e.runtime.eventData[t]["option.data_event"];
                                if (!e.isArray(p)) {
                                    var u = e.copy(n);
                                    if (p = [], e.isObject(u) && !e.isEmpty(u.value)) {
                                        if (u.type != e.const.DATA_ACTION_TYPE.section && u.type != e.const.DATA_ACTION_TYPE.popup || p.push({
                                            ...
                                            var m = e.findAncestor(o, "ladi-popup"), _ = e.findAncestor(o, "ladi-section"),
                                                y = null;
                                            e.isEmpty(m) ? e.isEmpty(_) || (y = _.id) : y = (m = e.findAncestor(m, "ladi-element")).id, e.isEmpty(y) || p.push({
                                                action_type: e.const.ACTION_TYPE.complete,
                                                type: e.const.DATA_ACTION_TYPE.hidden_show,
                                                hidden_ids: [y],
                                                show_ids: []
                                ...
                                for (var g = function () {
                                    ...
                                    c.forEach(function (t) {
                                        ...
                                        if (!e.isEmpty(o)) {
                                            ...
                                            if (0 == (s = s.unique()).length) {
                                                p++, (c = document.createElement("div")).className = "ladi-element ladi-hidden ladi-form-item-survey", c.id = e.randomString(10), c.setAttribute("data-name", n);
                                                var m = "";
                                    ...
                                    for (var t = !1, e = 0; e < r.length; e++) if (r[e].classList.contains("selected")) {
                                        t = !0;
                                        break
                                    }
                                    return t
                                    ...
                                    e.tapEventListener(t, function (i) {
                                        if (i.stopPropagation(), a) t.classList.contains("selected") ? t.classList.remove("selected") : t.classList.add("selected"); else for (var n = t.parentElement.getElementsByClassName("ladi-survey-option"), o = 0; o < n.length; o++) n[o] === t ? n[o].classList.add("selected") : n[o].classList.remove("selected");
                                        E(), e.isEmpty(s) && h()
                                    })
                                }, E = function () {
                                    var t = f();
                    ...
                    }(i, o.type, o["option.survey_setting.is_multiple"], o["option.survey_setting"] || o["option.survey_setting.event"])) : r(o, t).run(i, e.runtime.isDesktop)
                }), X(Date.now() + 1e3), W(), z(), (i = function () {
                    y.forEach(function (t) {
                        if ("countdown" == e.runtime.eventData[t].type) for (var i = document.querySelectorAll("#" + t), a = 0; a < i.length; a++) {
                            var n = i[a], o = n.getAttribute("data-type"), r = 0, s = 0, l = Date.now();
                            if (n.hasAttribute("data-date-start") || n.hasAttribute("data-date-end")) r = parseFloatLadiPage(n.getAttribute("data-date-start")) || 0, s = parseFloatLadiPage(n.getAttribute("data-date-end")) || 0; else {
                                if (o == e.const.COUNTDOWN_TYPE.countdown) {
                                    var d = parseInt(n.getAttribute("data-minute")) || 0;
                                    if (d <= 0) return;
                                    for (s = e.runtime.timenow; s <= l;) s += 60 * d * 1e3
                                }
                                if (o == e.const.COUNTDOWN_TYPE.endtime && (s = parseInt(n.getAttribute("data-endtime")) || 0), o == e.const.COUNTDOWN_TYPE.daily) {
                                    var c = n.getAttribute("data-daily-start"), p = n.getAttribute("data-daily-end");
                                    if (!e.isEmpty(c) && !e.isEmpty(p)) {
                                        var u = (new Date).toDateString();
                                        r = new Date(u + " " + c).getTime(), s = new Date(u + " " + p).getTime()
                                    }
                                }
                                n.setAttribute("data-date-start", r), n.setAttribute("data-date-end", s)
                            }
                            if (r > l) return;
                            var m = s - l;
                            m < 0 && (m = 0);
                            for (var _ = e.getCountdownTime(m), y = n.querySelectorAll("[data-item-type]"), g = 0; g < y.length; g++) y[g].querySelectorAll(".ladi-countdown-text span")[0].textContent = _[y[g].getAttribute("data-item-type")]
                        }
                    })
                })(), e.runtime.interval_countdown = e.runInterval(i, 1e3), y.forEach(function (t) {
                    var i = document.getElementById(t);
                    e.isEmpty(i) || j(t, i)
                }), e.runtime.interval_gallery = e.runInterval(G, 1e3), y.forEach(function (t) {
                    var i = e.runtime.eventData[t];
                    if ("carousel" == i.type) {
                        var a = document.getElementById(t);
                        if (!e.isEmpty(a)) {
                            ...
                            var n = i[e.runtime.device + ".option.carousel_setting.autoplay"],
                                o = i[e.runtime.device + ".option.carousel_setting.autoplay_time"], r = 0;
                            n && !e.isEmpty(o) && (r = o);
                            var s = function (i) {
                            ...
                            a.getElementsByClassName("ladi-carousel-arrow-left")[0].addEventListener("click", function (e) {
                                e.stopPropagation(), a.getElementsByClassName("ladi-carousel-content")[0].style.removeProperty("transition-duration"), a.setAttribute("data-is-next", !1), a.setAttribute("data-next-time", Date.now() + 1e3 * r), U(t, !1)
                                ...
                                e.stopPropagation(), a.getElementsByClassName("ladi-carousel-content")[0].style.removeProperty("transition-duration"), a.setAttribute("data-is-next", !0), a.setAttribute("data-next-time", Date.now() + 1e3 * r), U(t, !1)
                        ...
                        if ("carousel" == i.type) {
                            ...
                            if (!e.isEmpty(a) && "true" == a.getAttribute("data-scrolled") && "true" != a.getAttribute("data-stop")) {
                                ...
                                if (n && !e.isEmpty(o) && (r = o), r > 0) {
                                    var s = a.getAttribute("data-next-time"), l = Date.now();
                                    e.isEmpty(s) && (s = l + 1e3 * (r - 1), a.setAttribute("data-next-time", s)), l >= s && (U(t, !0), a.setAttribute("data-next-time", l + 1e3 * r))
                                }
                            }
                        }
                    })
                    ...
                    }, f = 0; f < e.runtime.tmp.list_form_checkout.length; f++) for (var h = document.querySelectorAll("#" + e.runtime.tmp.list_form_checkout[f] + " .ladi-form-item input.ladi-form-control"), v = 0; v < h.length; v++) -1 != t.indexOf(h[v].getAttribute("name")) && (h[v].addEventListener("change", g), h[v].addEventListener("input", g))
                }(), q(), t && (e.runtime.is_popupx || e.const.TIME_ONPAGE_TRACKING.forEach(function (t) {
                    e.runTimeout(function () {
                    ...
                    var t = 2500, i = 3800, a = 800, n = 50, o = 150, r = 500, s = 1300, l = 600, d = 1500, c = t,
                        p = function (p) {
                            var u = !1;
                            if (e.const.ANIMATED_LIST.forEach(function (t) {
                                ...
                                if (!e.isEmpty(m)) {
                                    ...
                                    if (0 != _.length) {
                                        var y = !1, g = e.randomId(), f = function (i, a, n, o) {
                                            if (!y) {
                                            ...
                                            if (!y) {
                                                var r = a.parentElement, s = r.parentElement;
                                            ...
                                            y || (e.isEmpty(e.findAncestor(t, "type")) ? e.isEmpty(e.findAncestor(t, "clip")) || (e.findAncestor(t, "ladipage-animated-words-wrapper").style.setProperty("width", t.clientWidth + 5 + "px"), e.runTimeout(function () {
                                                L(t)
                                            }, l + d)) : (h(t.querySelectorAll("i")[0], t, !1, i), t.classList.add("is-visible"), t.classList.remove("is-hidden")))
                                        }, L = function (d) {
                                            if (!y && !e.isEmpty(d)) {
                                                var c = v(d);
                                                if (e.isEmpty(e.findAncestor(d, "type"))) if (e.isEmpty(e.findAncestor(d, "letters"))) e.isEmpty(e.findAncestor(d, "clip")) ? e.isEmpty(e.findAncestor(d, "loading-bar")) ? (E(d, c), e.runTimeout(function () {
                                                    L(c)
                                                }, t)) : (e.findAncestor(d, "ladipage-animated-words-wrapper").classList.remove("is-loading"), E(d, c), e.runTimeout(function () {
                                                    L(c)
                                                }, i), e.runTimeout(function () {
                                                    e.findAncestor(d, "ladipage-animated-words-wrapper").classList.add("is-loading")
                                                }, a)) : (e.findAncestor(d, "ladipage-animated-words-wrapper").style.setProperty("width", "2px"), e.runTimeout(function () {
                                                    E(d, c), P(c)
                                                }, l)); else {
                                                    var p = d.querySelectorAll("i").length >= c.querySelectorAll("i").length;
                                        ...
                                        p.parentElement.insertBefore(A, p.nextSibling), A.outerHTML = p.outerHTML, (A = p.nextSibling).classList.add("ladipage-animated-headline-duplicate"), e.runtime.list_scrolling_exec[g] = function () {
                                        ...
                                        }, a); else if (p.classList.contains("clip")) {
                    ...
                    for (var t = document.querySelectorAll(".ladi-button-group > .ladi-element"), i = function (t) {
                        ...
                        if (!e.isEmpty(a)) for (var n = (a = e.findAncestor(a, "ladi-element")).querySelectorAll(".ladi-button-group > .ladi-element"), o = 0; o < n.length; o++) n[o].id != i.id && n[o].classList.remove("selected")
                                ...
                                if (!e.isEmpty(d)) {
                                    ...
                                    if (!e.isEmpty(c)) {
                                        ...
                                        if (e.isObject(p) && e.isObject(p.store_info) && e.isObject(p.product)) {
                                            ...
                                            if (-1 != u) for (var _ = 0; _ < m.length; _++) if (m[_].id != r.id && e.isEmpty(e.findAncestor(m[_], "ladi-collection"))) {
                                                ...
                                                if (!e.isEmpty(y)) {
                                                    ...
                                                    if (!e.isEmpty(g)) {
                                                        ...
                                                        var v = null, E = null, P = null, L = 0;
                                                        if (y["option.product_variant_type"] == e.const.PRODUCT_VARIANT_TYPE.combobox) {
                                                            if (!e.isArray(p.product.variants)) continue;
                                                            if (E = p.product.variants[u], e.isString(E.option_ids)) for (P = E.option_ids.split("/"), L = 0; L < P.length; L++) v = document.querySelector("#" + m[_].id + ' .ladi-form-item select[data-product-option-id="' + P[L] + '"]'), e.isEmpty(v) || v.getAttribute("data-store-id") != p.store_info.id || v.getAttribute("data-product-id") != E.product_id || (v.value = E["option" + (L + 1)])
                                                        }
                                                        if (y["option.product_variant_type"] == e.const.PRODUCT_VARIANT_TYPE.label) {
                                                            if (!e.isArray(p.product.variants)) continue;
                                                            if (E = p.product.variants[u], e.isString(E.option_ids)) for (P = E.option_ids.split("/"), L = 0; L < P.length; L++) v = document.querySelector("#" + m[_].id + ' .ladi-form-label-container[data-product-option-id="' + P[L] + '"]'), e.isEmpty(v) || v.getAttribute("data-store-id") != p.store_info.id || v.getAttribute("data-product-id") != E.product_id || e.runtime.tmp.updateLabelValue(v, E["option" + (L + 1)])
                                                        }
        ...
        }, e.runtime.tmp.runButtonSectionClose = D, e.runtime.tmp.runOptionAction = k, e.runtime.tmp.runOptionHover = x, e.runtime.tmp.runTrackingAnalytics = C, e.runtime.tmp.runLadiSaleProductKey = et, e.runtime.tmp.eventClickGalleryControlItem = H, e.runtime.tmp.runGallery = V, e.runtime.tmp.setGalleryStart = j, e.runtime.tmp.updateImageGalleryProduct = tt, e.runtime.tmp.runOptionCountdown = R, e.runtime.tmp.runOptionCountdownItem = F, e.runtime.tmp.getOptionLabelValue = K, e.runtime.tmp.updateLabelValue = J, e.runtime.tmp.getLabelValue = Z, e.runtime.tmp.clickLabelProductChangeCallback = Q, e.runtime.tmp.fireEventLabelChange = function (t) {
            var i = t.querySelector(".ladi-form-label-item.selected");
            e.isEmpty(i) || e.fireEvent(i, "click", {is_fire_event: !0})
        }, e.runtime.tmp.showPopupX = rt, e.runtime.tmp.runActionPopupX = it, e.runtime.is_popupx ? (e.runtime.tmp.popupx_iframe_id = e.randomId(), it({
            ladipage_id: e.runtime.ladipage_id,
            action: {type: "set_iframe_loaded"}
        }), window.addEventListener("message", function (t) {
            try {
                var i = JSON.parse(t.data);
                "POPUPX" == i.type && i.iframe_id == e.runtime.tmp.popupx_iframe_id && i.action.value.forEach(function (t) {
                    !function (t, i) {
                        var a = null, n = null;
                        if ("set_style_device" == t) {
                            if (lt(i.is_desktop), n = document.getElementById(e.runtime.tmp.popupx_current_element_id), e.isEmpty(n)) return;
                            "none" != getComputedStyle(n).display && (e.runtime.tmp.popupx_is_inline ? st(e.runtime.tmp.popupx_current_element_id, !1) : rt(e.runtime.tmp.popupx_current_element_id, !1))
                        }
                        if ("set_iframe_info" == t) {
                            e.isEmpty(f) && (f = i.ladi_client_id || e.randomId(), window.ladi("LADI_CLIENT_ID").set_cookie(f, 3650)), e.runtime.tmp.popupx_is_desktop = i.is_desktop, e.runtime.isDesktop = i.is_desktop, e.runtime.device = e.runtime.isDesktop ? e.const.DESKTOP : e.const.MOBILE, e.runtime.tmp.popupx_origin_store_id = i.origin_store_id, e.runtime.tmp.popupx_origin_referer = i.origin_referer, e.runtime.tmp.popupx_origin_domain = i.origin_domain, e.runtime.tmp.popupx_origin_url = i.origin_url, e.runtime.tmp.popupx_is_inline = i.is_inline, lt(i.is_desktop);
                            var o = "#" + e.runtime.builder_section_popup_id + " .ladi-container {width: 100% !important;}";
                            e.runtime.tmp.popupx_is_inline && (o += ".ladi-section > .ladi-section-close {display: none !important;}"), e.createStyleElement("style_popup_container", o), e.runtime.has_popupx = !0, dt()
                        }
                        "hide_popupx" == t && (a = e.runtime.eventData[i], n = document.getElementById(i), e.isEmpty(a) || e.isEmpty(n) || window.ladi(i).hide()), "show_popupx" == t && rt(i, !0), "show_popupx_inline_iframe" == t && st(i, !0), "show_message_callback" == t && (e.isFunction(e.runtime.tmp.popupx_show_message_callback) && e.runtime.tmp.popupx_show_message_callback(), delete e.runtime.tmp.popupx_show_message_callback)
                    }(i.action.type, t)
                })
            } catch (t) {
            }
        })) : dt(), e.runtime.isRun = !0
    } else e.loadHtmlGlobal(t)
}, LadiPageScriptV2.prototype.getListProductByTagId = function (t, e, i, a, n) {
    var o = this, r = t["option.form_account_id"], s = t["option.product_type"],
        l = t["option.ladisale_store_id"] || null, d = t["option.product_tag_id"], c = t["option.data_setting.value"],
        p = t["option.data_setting.type_dataset"], u = t["option.collection_setting.type"],
        m = t["option.data_setting.sort_name"], _ = t["option.data_setting.sort_by"], y = null, g = null, f = null,
        h = null, v = null;
    if (o.isArray(d) && d.length > 0) {
        if (o.isEmpty(o.runtime.tmp.product_tag_info[s]) && (o.runtime.tmp.product_tag_info[s] = {}), o.isEmpty(o.runtime.tmp.timeout_product_tag_info[s]) && (o.runtime.tmp.timeout_product_tag_info[s] = {}), d.sort(), f = JSON.stringify(d) + "_page_" + i + "_limit_" + e, h = o.runtime.tmp.product_tag_info[s][f], -1 != [o.const.FORM_CONFIG_TYPE.ladisales, o.const.FORM_CONFIG_TYPE.sapo, o.const.FORM_CONFIG_TYPE.haravan, o.const.FORM_CONFIG_TYPE.shopify, o.const.FORM_CONFIG_TYPE.wordpress].indexOf(s)) {
            g = function () {
                ...
                return o.isObject(h) && o.isArray(h.products) && (t = {
                    ...
                    o.runtime.tmp.product_info[s][t.product_id] = {store_info: h.store_info, product: t}
                })), t
            };
            var E = null;
                ...
                var P = function () {
                    ...
                    if (h = t.data, o.isObject(h)) {
                        if (!o.isObject(h.store_info)) {
                            ...
                            o.runtime.isClient || (a = LadiPage.getRootScope().getStoreCurrency()), h.store_info = {
                                currency: {
                                    code: a,
                        ...
                        if (s != o.const.FORM_CONFIG_TYPE.ladisales && (h.store_info.id = -1), o.isArray(h.products)) for (var r = null, l = function (t) {
                            return t.option1 == r
                        }, c = 0; c < h.products.length; c++) if (o.isArray(h.products[c].options) && o.isArray(h.products[c].variants)) {
                            ...
                            if (o.isArray(h.products[c].options) && 1 == h.products[c].options.length && o.isArray(h.products[c].options[0].values)) for (var m = 0; m < h.products[c].options[0].values.length; m++) {
        ...
        if (o.isArray(v)) {
            ...
            t = {
                ...
                o.runtime.tmp.product_info[s][t.id] = {store_info: {}, product: t}
            })
        }
        return t
    ...
    if (e.isEmpty(e.runtime.shopping_product_type) || window.ladi("_shopping_product_type").get_cookie() != e.runtime.shopping_product_type && (window.ladi("_cart_token").delete_cookie(), window.ladi("_checkout_token").delete_cookie(), window.ladi("_shopping_product_type").set_cookie(e.runtime.shopping_product_type, 30)), -1 == [e.const.FORM_CONFIG_TYPE.sapo, e.const.FORM_CONFIG_TYPE.haravan, e.const.FORM_CONFIG_TYPE.wordpress].indexOf(e.runtime.shopping_product_type)) if (-1 == [e.const.FORM_CONFIG_TYPE.shopify].indexOf(e.runtime.shopping_product_type)) {
        var a = window.ladi("_cart_token").get_cookie(), n = {"Content-Type": "application/json"};
        if (!this.isEmpty(a)) return n["cart-token"] = a, void this.sendRequest("POST", this.const.API_LADISALE_SHOW, JSON.stringify({type: "LP"}), !0, n, function (t, a, n) {
            if (n.readyState == XMLHttpRequest.DONE) {
                if (200 == a) try {
                    var o = JSON.parse(t);
                    200 == o.code && (e.runtime.tmp.ladisales_checkout_url = o.data.url, o.data.items.forEach(function (t) {
                        ...
                        }), n = t.quantity, r = t.option_name, s = t.price;
    ...
    var n = this.runtime.tmp.add_to_cart_fee_shipping || 0, o = this.runtime.tmp.add_to_cart_discount || 0,
        r = i + n - o;
    ...
    var s = this.formatNumber(i, 3), l = this.formatNumber(r, 3), d = this.formatNumber(n, 3),
    ...
    -1 != s && this.updateCartCookie({
        ...
        var t = document.getElementsByClassName("ladi-form-remove-coupon")[0];
        n.isEmpty(t) || t.click(), n.updateCartPromotion(), 0 == n.runtime.tmp.cart.length && -1 != [n.const.FORM_CONFIG_TYPE.ladisales].indexOf(n.runtime.shopping_product_type) && (window.ladi("_cart_token").delete_cookie(), window.ladi("_checkout_token").delete_cookie()), n.runResizeAll(), n.isFunction(a) && a(!0)
    }, function (t) {
    ...
    if (-1 != r) {
        var s = !1, l = -1, d = 1, c = null, p = null, u = this.runtime.tmp.cart[r];
        a.isEmpty(u) || (d = u.min_buy || d, c = u.max_buy);
        var m = this.runtime.tmp.cart[r].quantity;
        if (this.isEmpty(t.value)) i && (t.value = d), this.runtime.tmp.cart[r].quantity = d; else {
        ...
        g.product_type = this.runtime.tmp.cart[r].product_type, g.package_quantity = this.runtime.tmp.cart[r].package_quantity, this.updateCartCookie(g, !1, function () {
            ...
            if (a.changeTotalPriceCart(), -1 != (r = a.runtime.tmp.cart.findIndex(o))) {
                ...
                for (var n = document.querySelectorAll(".ladi-cart-price span[data-product-variant-id]"), s = 0; s < n.length; s++) if (n[s].getAttribute("data-store-id") == a.runtime.tmp.cart[r].store_id && n[s].getAttribute("data-product-id") == a.runtime.tmp.cart[r].product_id) {
                    ...
                    if (!a.isEmpty(l)) {
                        var d = a.findAncestor(t, "ladi-element"), c = a.findAncestor(l, "ladi-element");
    ...
    var o = this, r = t.target, s = o.generateVariantProduct(e, !1, null, null, null, null, !0, !0, function (r) {
        o.updateProductVariantSelectOption(t, e, i, a, n)
    });
    if (o.isObject(s)) {
        var l = o.getProductVariantId(r, s.product), d = o.findAncestor(r, "ladi-collection-item"), c = [], p = 0;
        if (o.isEmpty(d)) for (var u = document.querySelectorAll('[data-variant="true"]'), m = 0; m < u.length; m++) {
        ...
        var h = r.getAttribute("data-product-option-id"), v = null, E = null, P = null;
        if (o.isArray(s.product.variants) && 0 != s.product.variants.length) {
            if (o.isString(s.product.variants[0].option_ids)) {
                for (P = s.product.variants[0].option_ids.split("/"), p = 0; p < P.length; p++) if (P[p] == h) {
                    E = p;
                    break
                }
                if (!o.isEmpty(E)) {
                    ...
                    r.classList.contains("ladi-form-label-container") && (L = o.runtime.tmp.getLabelValue(r)), s.product.variants.forEach(function (t) {
                        if (o.isEmpty(L) || L == t["option" + (E + 1)]) for (p = 0; p < P.length; p++) o.isArray(v[P[p]]) || (v[P[p]] = []), p != E && v[P[p]].push(t["option" + (p + 1)])
                    })
                }
            }
            for (var A = v, b = [], w = [], S = null, T = 0; T < g.length; T++) {
                ...
                if (!o.isEmpty(O)) {
                    v = o.copy(A);
                    var C = 0, N = 0, I = 0, k = 0, x = null, D = null, R = null, F = null;
                    if (O["option.product_variant_type"] == o.const.PRODUCT_VARIANT_TYPE.combobox) {
                        if (S = g[T].querySelectorAll("select[data-product-option-id]"), o.isObject(v)) {
                            for (C = 0; C < S.length; C++) if ((x = S[C].getAttribute("data-product-option-id")) != h) for (o.isArray(v[x]) && -1 != v[x].indexOf(S[C].value) || (S[C].value = ""), D = S[C].getElementsByTagName("option"), N = 0; N < D.length; N++) o.isEmpty(D[N].getAttribute("value")) || D[N].removeAttribute("disabled");
                            for (C = 0; C < S.length; C++) {
                                for (x = S[C].getAttribute("data-product-option-id"), v = {}, I = 0; I < s.product.variants.length; I++) if (F = s.product.variants[I], P = F.option_ids.split("/"), -1 != (E = P.indexOf(x)) && (o.isEmpty(S[C].value) || S[C].value == F["option" + (E + 1)])) for (p = 0; p < P.length; p++) o.isArray(v[P[p]]) || (v[P[p]] = []), p != E && v[P[p]].push(F["option" + (p + 1)]);
                                for (k = 0; k < S.length; k++) if ((R = S[k].getAttribute("data-product-option-id")) != x) for (D = S[k].getElementsByTagName("option"), N = 0; N < D.length; N++) o.isEmpty(D[N].getAttribute("value")) || o.isArray(v[R]) && -1 != v[R].indexOf(D[N].getAttribute("value")) || D[N].setAttribute("disabled", "")
                            }
                        }
                        if (!o.isObject(v)) for (C = 0; C < S.length; C++) b.push(S[C])
                    }
                    if (O["option.product_variant_type"] == o.const.PRODUCT_VARIANT_TYPE.label) {
                        if (S = g[T].querySelectorAll(".ladi-form-label-container[data-product-option-id]"), o.isObject(v)) {
                            for (C = 0; C < S.length; C++) if ((x = S[C].getAttribute("data-product-option-id")) != h) {
                            ...
                            for (C = 0; C < S.length; C++) {
                                for (x = S[C].getAttribute("data-product-option-id"), v = {}, I = 0; I < s.product.variants.length; I++) if (F = s.product.variants[I], P = F.option_ids.split("/"), -1 != (E = P.indexOf(x))) {
                                    var B = o.runtime.tmp.getLabelValue(S[C]);
                                    if (o.isEmpty(B) || B == F["option" + (E + 1)]) for (p = 0; p < P.length; p++) o.isArray(v[P[p]]) || (v[P[p]] = []), p != E && v[P[p]].push(F["option" + (p + 1)])
                                }
                                for (k = 0; k < S.length; k++) if ((R = S[k].getAttribute("data-product-option-id")) != x) for (D = S[k].getElementsByClassName("ladi-form-label-item"), N = 0; N < D.length; N++) if (!D[N].classList.contains("no-value")) {
                                    var M = o.runtime.tmp.getOptionLabelValue(D[N]);
                                    o.isArray(v[R]) && -1 != v[R].indexOf(M) || D[N].classList.add("disabled")
                                }
                            }
                        }
                        if (!o.isObject(v)) for (C = 0; C < S.length; C++) w.push(S[C])
                    }
                }
            }
            ...
            for (S = document.querySelectorAll(".ladi-form .ladi-form-label-container"), T = 0; T < S.length; T++) {
                ...
                if (!o.isEmpty(V)) o.findAncestor(S[T], "ladi-element").getAttribute("data-title-type") == o.const.PRODUCT_VARIANT_TITLE.top && (V = ": " + V);
    ...
    if (a.isObject(n) && a.isObject(n.product)) {
        var o = i.querySelectorAll("select.ladi-form-control"), r = i.querySelectorAll(".ladi-form-label-container"),
            s = 0;
        if (a.isArray(n.product.variants) && 0 != n.product.variants.length) {
            ...
            })), a.isEmpty(l) && (l = n.product.variants[0]), e["option.product_variant_type"] == a.const.PRODUCT_VARIANT_TYPE.combined) for (s = 0; s < o.length; s++) d = o[s].querySelector('option[data-product-variant-id="' + l.product_variant_id + '"]'), a.isEmpty(d) || (o[s].value = d.getAttribute("value"), a.fireEvent(o[s], "change"));
            e["option.product_variant_type"] == a.const.PRODUCT_VARIANT_TYPE.combobox && a.isString(l.option_ids) && l.option_ids.split("/").forEach(function (t, e) {
                for (s = 0; s < o.length; s++) o[s].getAttribute("data-product-option-id") == t && (o[s].value = l["option" + (e + 1)] || "", a.fireEvent(o[s], "change"))
            }), e["option.product_variant_type"] == a.const.PRODUCT_VARIANT_TYPE.label && a.isString(l.option_ids) && l.option_ids.split("/").forEach(function (t, e) {
    ...
    if (i) n = a.runtime.tmp.cart; else {
        var o = LadiPage.getRootScope().getStoreCurrency();
        n = [{
            name: "Product Name",
    ...
    if (r += "<tbody>", 0 == n.length) r += '<tr><td class="ladi-cart-no-product">' + e + "</td></tr>"; else {
        n.forEach(function (e, n) {
            if (!(e.quantity <= 0)) {
                ...
                r += '<tr class="ladi-cart-row' + (a.isObject(e.promotion) ? " has-promotion" : "") + '"><td class="ladi-cart-image"><img src="' + s + '" />', t == a.const.CART_LAYOUT.viewonly && (r += '<span class="ladi-cart-image-quantity">' + e.quantity + "</span>"), r += "</td>", r += '<td class="ladi-cart-title"><span class="ladi-cart-title-name">' + e.name + '</span><span class="ladi-cart-title-variant">' + (e.title || "") + "</span>", a.isObject(e.promotion) && (r += '<span class="promotion-name">' + e.promotion.discount.note + "</span>"), r += "</td>", t == a.const.CART_LAYOUT.editable && (r += '<td class="ladi-cart-quantity"><div class="ladi-cart-quantity-content"><button onclick="javascript: LadiPageScript.buttonAddToCartProductQuantity(this, -1);" type="button"><span>-</span></button><input' + (i ? "" : " disabled") + ' type="number" min="1" value="' + e.quantity + '" oninput="javascript: LadiPageScript.changeAddToCartProductQuantity(this, \'' + o + '\', true);" /><button onclick="javascript: LadiPageScript.buttonAddToCartProductQuantity(this, 1);" type="button"><span>+</span></button></div></td>'), r += '<td class="ladi-cart-price"><span' + (a.isNull(e.store_id) ? "" : ' data-store-id="' + e.store_id + '"') + ' data-product-id="' + e.product_id + '" data-product-variant-id="' + e.product_variant_id + '" data-cart-item-key="' + e.cart_item_key + '">';
                var l = e.price * e.quantity, d = a.formatNumber(l, 3);
                a.isObject(e.currency) && !a.isEmpty(e.currency.symbol) && (d = a.formatCurrency(l, e.currency.symbol, !0)), r += d + "</span>", a.isObject(e.promotion) && (l = e.promotion.total, d = a.formatNumber(l, 3), a.isObject(e.currency) && !a.isEmpty(e.currency.symbol) && (d = a.formatCurrency(l, e.currency.symbol, !0)), r += '<span class="price-compare">' + d + "</span>"), r += "</td>", t == a.const.CART_LAYOUT.editable && (r += '<td class="ladi-cart-action"><button onclick="javascript: LadiPageScript.removeAddToCartProduct(\'' + o + '\', true);" type="button"><span>X</span></button></td>', r += "</tr>")
            }
        })
    }
    return r += "</tbody>"
}, LadiPageScriptV2.prototype.getProductVariantId = function (t, e) {
    var i = null, a = this.findAncestor(t, "ladi-element"), n = this;
    if (!this.isEmpty(a)) {
        ...
        if (!this.isEmpty(o) && (o["option.product_variant_type"] == this.const.PRODUCT_VARIANT_TYPE.combobox || o["option.product_variant_type"] == this.const.PRODUCT_VARIANT_TYPE.label)) {
            ...
            for (var c = 0; c < l.length; c++) d[l[c].getAttribute("data-product-option-id")] = (n.isEmpty(l[c].value) ? "" : l[c].value).trim();
            for (l = a.querySelectorAll(".ladi-form-label-container[data-product-option-id]"), c = 0; c < l.length; c++) d[l[c].getAttribute("data-product-option-id")] = n.runtime.tmp.getLabelValue(l[c]).trim();
            this.isArray(e.variants) && e.variants.forEach(function (t) {
                if (n.isEmpty(i)) {
                    var e = !0;
                    if (n.isString(t.option_ids)) for (var a = t.option_ids.split("/"), o = 0; o < a.length; o++) if (d[a[o].trim()] != (t["option" + (o + 1)] || "").trim()) {
                        e = !1;
                        break
                    }
    ...
    var i = this, a = -1, n = e["option.product_type"], o = e["option.ladisale_store_id"] || null,
        r = e["option.product_id"], s = i.generateVariantProduct(e, !1, null, null, null, null, !0, !0);
                        ...
                        if (!i.isEmpty(p)) {
                            ...
                            if (p["option.product_variant_type"] == i.const.PRODUCT_VARIANT_TYPE.combobox && (u = c.querySelectorAll(".ladi-form-item select[data-product-option-id]"), a = s.product.variants.findIndex(function (t) {
                                for (var e = !0, a = null, n = function (t) {
                                    return t == a
                                }, o = 0; o < u.length; o++) if (u[o].getAttribute("data-store-id") == s.store_info.id && u[o].getAttribute("data-product-id") == t.product_id) {
    ...
    var d = a["option.product_type"], c = a["option.product_mapping_name"],
        ...
        var g = function () {
            if (-1 != [l.const.FORM_CONFIG_TYPE.ladisales, l.const.FORM_CONFIG_TYPE.sapo, l.const.FORM_CONFIG_TYPE.haravan, l.const.FORM_CONFIG_TYPE.shopify, l.const.FORM_CONFIG_TYPE.wordpress].indexOf(d)) {
                ...
                if (-1 != ["image"].indexOf(c) && (_ = p.product[c], l.isObject(_) && (e = _.src, l.isEmpty(e) || !l.isString(e) || e.startsWith("http://") || e.startsWith("https://") || e.startsWith("//") || (e = "https://" + l.const.STATIC_W_DOMAIN + "/" + e))), -1 != ["images"].indexOf(c) && (_ = p.product[c], l.isArray(_) && (e = [], _.forEach(function (t) {
                    l.isEmpty(t.src) || (!l.isString(t.src) || t.src.startsWith("http://") || t.src.startsWith("https://") || t.src.startsWith("//") ? e.push({src: t.src}) : e.push({src: "https://" + l.const.STATIC_W_DOMAIN + "/" + t.src}))
                    ...
                    if (l.isEmpty(o) || (t = p.product.variants.findIndex(function (t) {
                        ...
                        if (-1 != ["sku", "variant_timezone"].indexOf(c) && (_ = r[c], e = _), -1 != ["title"].indexOf(c) && (_ = r[c] || r.product_name, e = _), -1 != ["text_quantity"].indexOf(c) && (_ = 1 == r.inventory_checked ? r[c] : "", e = _), -1 != ["weight"].indexOf(c) && (_ = r[c], l.isEmpty(r.weight_unit) || (_ += r.weight_unit), e = _), -1 != ["price", "compare_price"].indexOf(c) && (l.isEmpty(r[c]) ? _ = "" : (_ = l.formatNumber(r[c], 3), l.isObject(p.store_info) && l.isObject(p.store_info.currency) && !l.isEmpty(p.store_info.currency.symbol) && (_ = l.formatCurrency(r[c], p.store_info.currency.symbol, !0))), e = _), -1 != ["price_sale"].indexOf(c)) {
                            var f = 0;
                        ...
                        -1 != ["description"].indexOf(c) && (_ = r[c], l.isEmpty(_) || (e = _))
                    } else e = _ = ""
                }
            } else {
                if (_ = p.product[c], l.isBoolean(_)) _ = _ ? l.const.LANG.OPTION_TRUE : l.const.LANG.OPTION_FALSE; else try {
                    (y = new Date(_)).toISOString() == _ && (_ = y.getFullYear() + "-" + m(y.getMonth() + 1) + "-" + m(y.getDate()) + " " + m(y.getHours()) + ":" + m(y.getMinutes()) + ":" + m(y.getSeconds()))
                } catch (t) {
                }
                e = _
    ...
    var d = e ? "" : null, c = this, p = function (t) {
        ...
        if (c.isObject(t)) {
            ...
            i == c.const.PRODUCT_VARIANT_TYPE.combined && (s += '<div class="ladi-form-item-container"><div class="ladi-form-item-background"></div><div class="ladi-form-item"><select' + (c.isObject(t.store_info) && !c.isNull(t.store_info.id) ? ' data-store-id="' + t.store_info.id + '"' : "") + ' data-product-id="' + t.product.product_id + '" required tabindex="' + o + '" class="ladi-form-control ladi-form-control-select" data-selected=""' + (r ? "" : ' onmousedown="javascript: event.preventDefault();"') + ">", c.runtime.isClient && (s += '<option value="" data-product-variant-id="">' + c.const.LANG.OPTION_NO_SELECT + "</option>"), c.isArray(t.product.variants) && t.product.variants.forEach(function (e, i) {
                ...
                if (e.is_tmp) s += '<div class="ladi-form-item-box"></div>'; else if (c.isArray(e.values) && 0 != e.values.length) {
                ...
                if (c.isArray(e.values) && 0 != e.values.length) {
                    s += '<div class="ladi-form-item-box">', c.isEmpty(a) || (s += '<div class="ladi-form-item-title">', s += "<span>" + e.name + "</span>", s += '<span class="ladi-form-item-title-value"></span>', s += "</div>"), s += '<div class="ladi-form-label-container"' + (c.isObject(t.store_info) && !c.isNull(t.store_info.id) ? ' data-store-id="' + t.store_info.id + '"' : "") + ' data-product-id="' + e.product_id + '" data-product-option-id="' + e.product_option_id + '" data-selected="">';
                    var i = null;
                    c.isArray(t.product.variants) && (i = t.product.variants[0]);
                    var n = null;
                    c.isEmpty(i) || c.isString(i.option_ids) && (n = i.option_ids.split("/"));
    ...
    var u = t["option.form_account_id"], m = t["option.product_type"], _ = t["option.ladisale_store_id"] || null,
        y = t["option.product_id"], g = t["option.data_setting.value"], f = t["option.data_setting.type_dataset"],
        h = t["option.data_setting.sort_name"], v = t["option.data_setting.sort_by"], E = null, P = null;
    if (-1 != [c.const.FORM_CONFIG_TYPE.ladisales, c.const.FORM_CONFIG_TYPE.sapo, c.const.FORM_CONFIG_TYPE.haravan, c.const.FORM_CONFIG_TYPE.shopify, c.const.FORM_CONFIG_TYPE.wordpress].indexOf(m)) {
        if (!c.isEmpty(y)) {
            if (c.isEmpty(c.runtime.tmp.product_info[m]) && (c.runtime.tmp.product_info[m] = {}), c.isEmpty(c.runtime.tmp.timeout_product_info[m]) && (c.runtime.tmp.timeout_product_info[m] = {}), y = parseInt(y) || y, E = c.runtime.tmp.product_info[m][y], P = function () {
                ...
                var L = function () {
                    ...
                    if (E = c.isObject(c.runtime.tmp.product_info[m][y]) ? c.runtime.tmp.product_info[m][y] : t.data, c.isObject(E)) {
                        if (!c.isObject(E.store_info)) {
                            ...
                            c.runtime.isClient || (e = LadiPage.getRootScope().getStoreCurrency()), E.store_info = {
                                currency: {
                                    code: e,
                        ...
                        if (m != c.const.FORM_CONFIG_TYPE.ladisales && (E.store_info.id = -1), c.isObject(E.product) && c.isArray(E.product.options) && c.isArray(E.product.variants)) {
                            ...
                            if (c.isArray(E.product.options) && 1 == E.product.options.length && c.isArray(E.product.options[0].values)) for (var n = null, o = function (t) {
                                return t.option1 == n
                ...
                }, b = {product_id: y}, w = null, S = "POST";
                return c.runLimitRequest(20, function () {
                    if (c.runtime.isClient) {
                        var t = c.const.API_LADISALE_SHOW_PRODUCT;
                        m == c.const.FORM_CONFIG_TYPE.ladisales ? ((w = {"Content-Type": "application/json"})["Store-Id"] = _, b = JSON.stringify(b)) : m == c.const.FORM_CONFIG_TYPE.wordpress ? (S = "GET", t = window.location.origin + "/ladipage/api?action=product_info&product_id=" + y, b = null) : (w = {"Content-Type": "application/json"}, t = c.const.API_SHOW_PRODUCT, b = {
                            form_account_id: u,
                            product_id: y
    ...
    e instanceof LadiPageScriptV2 || (e = LadiPageScript);
    var i = function (t, i) {
        window.ladi("_ladipage_" + t).set_cookie(i, 365, "/", window.location.host), e.isArray(e.runtime.DOMAIN_SET_COOKIE) && e.runtime.DOMAIN_SET_COOKIE.forEach(function (e) {
    ...
    var a = function (t, i) {
        ...
        for (var a = null, n = e.runtime.tmp.add_to_cart_shipping_method_id, o = function (t) {
            ...
            var l = r[s], d = l.getElementsByTagName("option");
    ...
    e.runtime.tmp.timeout_reload_fee_shipping = e.runTimeout(function () {
        if (0 != e.runtime.tmp.list_form_checkout.length) {
            var n = null;
            if (n = e.isEmpty(t) ? document.getElementById(e.runtime.tmp.list_form_checkout[0]) : e.findAncestor(t.target, "ladi-form"), e.isEmpty(n)) a(0); else {
                ...
                if (e.isEmpty(o) || e.isEmpty(r) || e.isEmpty(s)) a(0); else {
                    var l = o.value, d = r.value, c = s.value;
                    if (e.isEmpty(l) || e.isEmpty(d)) return void a(0);
                    var p = {state_id: l.split(":")[0], district_id: d.split(":")[0], ward_id: c.split(":")[0]};
                    ...
                    var u = null, m = null, _ = null;
                    if (e.runtime.shopping_product_type == e.const.FORM_CONFIG_TYPE.sapo) return m = function (t, n) {
                        t = t.querySelector("#checkoutForm"), (u = new FormData).append("_method", "patch"), u.append("billingProvince", p.state_id), u.append("billingDistrict", p.district_id), u.append("billingWard", p.ward_id), e.sendRequest("POST", window.location.origin + t.getAttribute("action"), u, !0, _, function (t, n, o) {
                            if (o.readyState == XMLHttpRequest.DONE) {
                                if (200 == n) try {
                                    for (var r = 0, s = [], c = e.createTmpElement("div", t, null, !1).querySelectorAll('[for^="shippingMethod-"]'), p = 0; p < c.length; p++) {
                                        var u = "", m = 0, _ = "", y = c[p].querySelector("span.radio__label__primary");
                                        e.isEmpty(y) || (u = y.textContent.trim()), y = c[p].querySelector("span.content-box__emphasis"), e.isEmpty(y) || (m = parseFloatLadiPage(y.textContent.trim().replaceAll(".", "").replaceAll(",", ".")) || 0);
                    ...
                    if (e.runtime.shopping_product_type == e.const.FORM_CONFIG_TYPE.haravan) return m = function (t) {
                        ...
                        n.search = n.search + (e.isEmpty(n.search) ? "?" : "&") + "customer_shipping_province=" + p.state_id + "&customer_shipping_district=" + p.district_id + "&form_name=form_update_location", t = n.href, e.sendRequest("GET", t, null, !0, _, function (t, n, o) {
                            if (o.readyState == XMLHttpRequest.DONE) {
                                if (200 == n) try {
                                    for (var r = 0, s = [], c = e.createTmpElement("div", t, null, !1).querySelectorAll('[for^="shipping_rate_id_"]'), p = 0; p < c.length; p++) {
                                        var u = "", m = 0, _ = "", y = c[p].querySelector("span.radio-label-primary");
                                        e.isEmpty(y) || (u = y.textContent.trim()), y = c[p].querySelector("span.content-box-emphasis"), e.isEmpty(y) || (m = parseFloatLadiPage(y.textContent.trim().replaceAll(",", "")) || 0);
                    ...
                    var y = window.ladi("_cart_token").get_cookie(), g = window.ladi("_checkout_token").get_cookie();
    ...
    var i = this, a = window.location.origin + "/checkout", n = function (n, o, r) {
        t && (a = i.getLinkUTMRedirect(a, null), a = i.convertDataReplaceStr(a, !0), window.ladi(a).open_url()), i.isFunction(e) && e(a, n, o, r)
    };
    ...
    }), -1 != [i.const.FORM_CONFIG_TYPE.wordpress].indexOf(i.runtime.shopping_product_type) && n(), -1 != [i.const.FORM_CONFIG_TYPE.ladisales].indexOf(i.runtime.shopping_product_type) && (i.isNull(i.runtime.shopping_config_checkout_id) ? (a = i.runtime.tmp.ladisales_checkout_url, n()) : (t && window.ladi("POPUP_CHECKOUT").show(), i.isFunction(e) && e()))
    ...
    t.getCheckoutSapo(null, function (e, i) {
        ...
        if (!t.isEmpty(n)) {
            ...
            if (!t.isEmpty(r)) {
                var s = t.findAncestor(r, "ladi-form").querySelector('input[name="coupon"]');
    ...
    var i = e.runtime.tmp.current_use_coupon, a = function (n, o) {
        ...
        var r = null, s = document.getElementsByClassName("ladi-form-remove-coupon")[0];
        ...
        if (e.isEmpty(l) || l.classList.remove("pointer-events-none"), !e.isEmpty(e.runtime.tmp.current_use_coupon)) {
            ...
            (s = document.createElement("span")).className = "ladi-form-remove-coupon", s.innerHTML = "âŒ«", s.addEventListener("click", function (t) {
                t.stopPropagation();
            ...
            }), e.findAncestor(l, "ladi-form-item").appendChild(s), l.classList.add("pointer-events-none")
        }
        if ((i != e.runtime.tmp.current_use_coupon || e.isEmpty(t) || !t.isRemoveCoupon || !e.isEmpty(t.docCrawl)) && e.runtime.shopping_product_type == e.const.FORM_CONFIG_TYPE.haravan) {
            if (delete e.runtime.tmp.use_cart_line_price_original, !e.isEmpty(e.runtime.tmp.current_use_coupon)) {
                ...
                if (!e.isEmpty(d)) d = (parseFloatLadiPage(d.getAttribute("data-checkout-subtotal-price-target")) || 0) / 100, e.changeTotalPriceCart(!0).cart_price != d && (e.runtime.tmp.use_cart_line_price_original = !0)
            }
            e.updateCartPromotion()
        }
    };
    e.isEmpty(t) || e.isEmpty(t.discount_price) ? e.runtime.tmp.is_click_check_price_discount || e.isEmpty(t) && e.isEmpty(e.runtime.tmp.current_use_coupon) || (e.isEmpty(e.runtime.tmp.timeout_reload_price_discount) || e.removeTimeout(e.runtime.tmp.timeout_reload_price_discount), e.runtime.tmp.timeout_reload_price_discount = e.runTimeout(function () {
        if (0 != e.runtime.tmp.list_form_checkout.length) {
            var i = null;
            if (e.isEmpty(t) ? i = document.getElementById(e.runtime.tmp.list_form_checkout[0]) : (i = e.findAncestor(t.target, "ladi-form"), e.isEmpty(i) || (i = i.querySelector("[data-submit-form-id]"), e.isEmpty(i) || (i = document.getElementById(i.getAttribute("data-submit-form-id"))))), e.isEmpty(i)) a(0); else {
                var n = null, o = i.querySelector('.ladi-form-item input[name="email"]'),
                    r = i.querySelector('.ladi-form-item input[name="phone"]'),
                    s = i.querySelector('.ladi-form-item input[name="coupon"]');
                if (e.isEmpty(s)) a(0); else {
                    ...
                    n = {discount_code: d}, e.isEmpty(o) || (n.email = o.value), e.isEmpty(r) || (n.phone = r.value), e.runtime.tmp.is_click_check_price_discount = !0;
                    var c = null, p = null, u = null;
                    if (e.runtime.shopping_product_type == e.const.FORM_CONFIG_TYPE.sapo) return p = function (i, o) {
                        i = i.querySelector("#checkoutForm"), (u = new FormData).append("_method", "patch"), u.append("reductionCode", n.discount_code), u.append("email", n.email), e.sendRequest("POST", window.location.origin + i.getAttribute("action"), u, !0, c, function (i, n, o) {
                            if (o.readyState == XMLHttpRequest.DONE) {
                                if (200 == n) try {
                                    var r = 0, s = e.createTmpElement("div", i, null, !1),
                                    ...
                                    if (e.isEmpty(l)) {
                                        ...
                                        e.isEmpty(p) || (r = parseFloatLadiPage(p.textContent.trim().replaceAll(".", "").replaceAll(",", ".")) || 0)
                                    }
                                    return void a(r)
                                } catch (t) {
                                }
                        ...
                        e.isEmpty(n.discount_code) ? o.search = o.search + (e.isEmpty(o.search) ? "?" : "&") + "form_name=form_discount_remove" : o.search = o.search + (e.isEmpty(o.search) ? "?" : "&") + "discount.code=" + n.discount_code + "&form_name=form_discount_add", i = o.href, e.sendRequest("GET", i, null, !0, c, function (i, n, o) {
                            if (o.readyState == XMLHttpRequest.DONE) {
                                if (200 == n) try {
                                    ...
                                    if (e.isEmpty(l) || l.textContent.trim().toLowerCase() != d.trim().toLowerCase()) {
        ...
        for (var e = 0; e < a.runtime.tmp.cart.length; e++) {
            ...
            if (i.product_id == t.product_id && i.product_variant_id == t.product_variant_id) {
                ...
                for (var n = document.querySelectorAll('.ladi-cart .ladi-cart-row .ladi-cart-price span[data-product-variant-id="' + i.product_variant_id + '"]'), o = 0; o < n.length; o++) {
                    var r = a.findAncestor(n[o], "ladi-cart-row"), s = r.querySelector(".ladi-cart-price"),
                        l = r.querySelector(".ladi-cart-title"), d = s.querySelector("span.price-compare"),
                        c = l.querySelector("span.promotion-name");
                    if (a.isObject(i.promotion)) {
                        r.classList.add("has-promotion"), a.isEmpty(d) && ((d = document.createElement("span")).className = "price-compare", s.appendChild(d));
                        var p = a.formatNumber(t.total, 3);
                        a.isObject(i.currency) && !a.isEmpty(i.currency.symbol) && (p = a.formatCurrency(t.total, i.currency.symbol, !0)), d.innerHTML = p, a.isEmpty(c) && ((c = document.createElement("span")).className = "promotion-name", l.appendChild(c)), c.innerHTML = i.promotion.discount.note
    ...
    if (a.isObject(a.runtime.tmp.info_update_cart_promotion) || (a.runtime.tmp.info_update_cart_promotion = {}), !a.isEmpty(t)) {
        ...
        return -1 != [a.const.FORM_CONFIG_TYPE.sapo, a.const.FORM_CONFIG_TYPE.haravan, a.const.FORM_CONFIG_TYPE.shopify].indexOf(a.runtime.shopping_product_type) && t.items.forEach(function (t) {
            ...
            a.runtime.isClient || (i = LadiPage.getRootScope().getStoreCurrency()), e.currency = {
                code: i,
            ...
            if (-1 != [a.const.FORM_CONFIG_TYPE.sapo, a.const.FORM_CONFIG_TYPE.haravan].indexOf(a.runtime.shopping_product_type)) {
                if (e.price = t.price_original, a.isObject(t.properties)) {
                    ...
                    s.length > 0 && (o = t.properties[s[0]], -1 != [a.const.FORM_CONFIG_TYPE.haravan].indexOf(a.runtime.shopping_product_type) && ((o = o.split("-")).shift(), o = (o = o.join("-")).trim()), r = {
                        product_id: t.product_id,
                        product_variant_id: t.variant_id,
            ...
            a.runtime.isClient || (n = LadiPage.getRootScope().getStoreCurrency()), i.currency = {
                code: n,
    ...
    if (!0 !== a.runtime.tmp.info_update_cart_promotion[s]) {
        ...
        if (a.runtime.tmp.info_update_cart_promotion[s] = !0, -1 == [a.const.FORM_CONFIG_TYPE.sapo, a.const.FORM_CONFIG_TYPE.haravan, a.const.FORM_CONFIG_TYPE.shopify].indexOf(a.runtime.shopping_product_type)) if (-1 == [a.const.FORM_CONFIG_TYPE.wordpress].indexOf(a.runtime.shopping_product_type)) {
            var c = window.ladi("_cart_token").get_cookie(), p = {"Content-Type": "application/json"};
    ...
    var o = this, r = {}, s = null, l = null;
    if (-1 != [o.const.FORM_CONFIG_TYPE.sapo, o.const.FORM_CONFIG_TYPE.haravan, o.const.FORM_CONFIG_TYPE.shopify].indexOf(o.runtime.shopping_product_type)) return -1 != [o.const.FORM_CONFIG_TYPE.sapo].indexOf(o.runtime.shopping_product_type) && ((l = new FormData).append("variantId", e.product_variant_id), l.append("quantity", e.quantity)), -1 != [o.const.FORM_CONFIG_TYPE.haravan].indexOf(o.runtime.shopping_product_type) && (s = {
        "Content-Type": "application/x-www-form-urlencoded",
        "X-Requested-With": "XMLHttpRequest"
    }, l = {id: e.product_variant_id, quantity: e.quantity}, l = Object.keys(l).reduce(function (t, e) {
        ...
        quantity: e.quantity,
        form_type: "product"
    }, l = Object.keys(l).reduce(function (t, e) {
        return t.push(e + "=" + encodeURIComponent(l[e])), t
    ...
    if (-1 == [o.const.FORM_CONFIG_TYPE.wordpress].indexOf(o.runtime.shopping_product_type)) {
        ...
        (s = {"Content-Type": "application/json"})["store-id"] = t, this.isEmpty(d) || (s["cart-token"] = d);
        var c = e.quantity;
        l = JSON.stringify({
            type: "LP",
            product_variant_id: e.product_variant_id,
            ...
            if (s.readyState == XMLHttpRequest.DONE) {
                if (200 == e) try {
                    if (200 == (r = JSON.parse(t)).code) return window.ladi("_cart_token").set_cookie(r.data.cart_token, 30), window.ladi("_checkout_token").set_cookie(r.data.checkout_token, 30), o.runtime.tmp.ladisales_checkout_url = r.data.url, o.isFunction(i) && i(), o.isFunction(n) && n(), o.reloadPriceDiscount(), void o.reloadFeeShipping()
                } catch (t) {
                }
                o.isFunction(a) && a(r), o.isFunction(n) && n()
            }
        ...
        if (s.readyState == XMLHttpRequest.DONE) {
            if (200 == e) try {
                if (200 == (r = JSON.parse(t)).code) return o.updateCartPromotion(r), o.isFunction(i) && i(), o.isFunction(n) && n(), o.reloadPriceDiscount(), void o.reloadFeeShipping()
            } catch (t) {
            }
            o.isFunction(a) && a(r), o.isFunction(n) && n()
        }
    ...
    var o = this, r = {}, s = null, l = null, d = null;
    if (-1 == [o.const.FORM_CONFIG_TYPE.sapo, o.const.FORM_CONFIG_TYPE.haravan, o.const.FORM_CONFIG_TYPE.shopify].indexOf(o.runtime.shopping_product_type)) {
        ...
        l = {"Content-Type": "application/json"}, this.isEmpty(c) || (l["cart-token"] = c);
        var p = t.quantity;
        s = JSON.stringify({
            product_variant_id: t.product_variant_id,
            quantity: p
            ...
            if (s.readyState == XMLHttpRequest.DONE) {
                if (200 == e) try {
                    if (200 == (r = JSON.parse(t)).code) return o.isFunction(i) && i(), o.isFunction(n) && n(), o.reloadPriceDiscount(), void o.reloadFeeShipping()
                } catch (t) {
                }
                o.isFunction(a) && a(r), o.isFunction(n) && n()
            }
        ...
        if (-1 != [o.const.FORM_CONFIG_TYPE.sapo].indexOf(o.runtime.shopping_product_type) && (d = window.location.origin + "/cart/change.js", (s = new FormData).append("variantId", t.product_variant_id), s.append("quantity", t.quantity)), -1 != [o.const.FORM_CONFIG_TYPE.haravan].indexOf(o.runtime.shopping_product_type) && (d = window.location.origin + "/cart/update.js", l = {
            "Content-Type": "application/x-www-form-urlencoded",
            "X-Requested-With": "XMLHttpRequest"
    ...
    var o = this, r = e["option.product_type"], s = e["option.ladisale_store_id"], l = e["option.product_tag_id"],
        d = e["option.collection_setting.type"], c = o.runtime.eventData[t];
    if (!o.isEmpty(c) && "collection" == c.type) {
        var p = this.runtime.isDesktop ? this.const.DESKTOP : this.const.MOBILE,
            u = c[p + ".option.collection_setting.row"], m = c[p + ".option.collection_setting.column"],
            _ = function (t, e, i, a, n, r) {
                    ...
                    var s = o.generateVariantProduct(i, !0, a["option.product_variant_type"], a["option.product_variant_title"], a["option.product_variant_price"], a["option.input_tabindex"], o.runtime.isClient, !0, function (o) {
                            ...
                            o.updateProductVariantSelectOption(e, i, a, !1, function () {
                                ...
                                if (!o.isEmpty(s)) {
                                    ...
                                    if (!o.isEmpty(l)) for (var d = l.querySelectorAll('[data-variant="true"]'), c = 0; c < d.length; c++) if (d[c].id != s.id) {
                                        var p = o.runtime.eventData[d[c].id], u = null, m = null, _ = null, y = 0;
                                        if (p["option.product_variant_type"] == o.const.PRODUCT_VARIANT_TYPE.combobox && (m = n.variants[a], o.isObject(m) && o.isString(m.option_ids))) for (_ = m.option_ids.split("/"), y = 0; y < _.length; y++) u = d[c].querySelector('select[data-product-option-id="' + _[y] + '"]'), o.isEmpty(u) || (u.value = m["option" + (y + 1)]);
                                        if (p["option.product_variant_type"] == o.const.PRODUCT_VARIANT_TYPE.label && (m = n.variants[a], o.isObject(m) && o.isString(m.option_ids))) for (_ = m.option_ids.split("/"), y = 0; y < _.length; y++) u = d[c].querySelector('.ladi-form-label-container[data-product-option-id="' + _[y] + '"]'), o.isEmpty(u) || o.runtime.tmp.updateLabelValue(u, m["option" + (y + 1)]);
                        ...
                        }, d = o.runtime.tmp.getOptionLabelValue, c = o.runtime.tmp.updateLabelValue,
                        p = o.runtime.tmp.getLabelValue, u = function (t) {
                ...
                if (a["option.input_type"] == o.const.INPUT_TYPE.number) {
                    var m = e.querySelector('input[name="quantity"]'), y = function (t) {
                        if (!o.isEmpty(t.target.value)) {
                            ...
                            if (!(o.isEmpty(e) || o.isEmpty(e.store_info) || o.isEmpty(e.product))) {
                                ...
                                if (-1 != r) {
                                    var s = e.product.variants[r].quantity, l = e.product.variants[r].quantity_stock;
                                    s = o.isNull(l) ? s : l;
                                    var d = parseInt(t.target.value) || 0, c = 1;
                                    c = e.product.variants[r].min_buy || c;
                                    var p = e.product.variants[r].max_buy, u = 0,
                    ...
                    m.addEventListener("input", y), o.fireEvent(m, "input");
                    var g = e.querySelectorAll("button")[0], f = e.querySelectorAll("button")[1];
                ...
                if ("button" == a.type && (a["option.is_buy_now"] || a["option.is_add_to_cart"])) {
                    var h = function () {
                        ...
                        t.forEach(function (t) {
                            t.action_type == o.const.ACTION_TYPE.action && (t.type == o.const.DATA_ACTION_TYPE.popup_cart && (window.ladi("POPUP_CART").show(), o.runEventTracking(e.id, !1)), t.type == o.const.DATA_ACTION_TYPE.popup_checkout && (o.runtime.shopping_third_party ? o.getThirdPartyCheckoutUrl(!0) : window.ladi("POPUP_CHECKOUT").show(), o.runEventTracking(e.id, !1)))
                        })
                    };
                ...
                var s = !o.isEmpty(e["option.product_mapping_name"]), l = JSON.stringify(e), d = null, c = null;
                if (s) if (a && o.isEmpty(i)) d = ""; else if (!o.isEmpty(e["option.product_id"]) && l === (d = (c = o.generateProductKey(!0, l, !0, e, !0, i, null, function (o) {
                    y(t, e, i, a, n, r)
                })).value)) return;
                var p = e.type, u = null, m = null;
                ...
                if ("gallery" == p) {
                    ...
                    o.isEmpty(g) || g.classList.remove("selected");
                    ...
                    f = t.getElementsByClassName("ladi-gallery-control-item")[0], g = t.getElementsByClassName("ladi-gallery-view-item")[0], o.isEmpty(g) || g.classList.add("selected"), o.isEmpty(f) || f.classList.add("selected");
                ...
                var c = u * m, p = o.getListProductByTagId(e, c, i, !0, function () {
                    g(t, e)
                });
                if (o.isObject(p) && o.isArray(p.products)) {
                    var f = document.getElementById(t);
                    if (o.isEmpty(f)) return;
                    ...
                    if (!o.isEmpty(p.total_record) && i * c >= p.total_record) {
                        if (d == o.const.COLLECTION_TYPE.readmore) {
                            ...
                            o.isEmpty(E) || E.setAttribute("data-opacity", "0")
                        }
                    ...
                    var x = I[i - 1], D = x.getElementsByClassName("ladi-collection-item");
                    if (D.length != p.products.length) for (; D.length > 0;) D[0].parentElement.removeChild(D[0]);
                    var R = function (t, i, a, n, d, c) {
                        ...
                        for (var p = function (t, e) {
                            ...
                            o.isEmpty(m) || (p(t[u], m), m["option.product_type"] = r, m["option.ladisale_store_id"] = s, m["option.product_tag_id"] = l, m["option.product_id"] = i.id, a && (o.isFunction(o.runtime.tmp.runOptionAction) && o.runtime.tmp.runOptionAction(t[u], t[u].id, m.type, m), o.isFunction(o.runtime.tmp.runOptionHover) && o.runtime.tmp.runOptionHover(t[u], t[u].id, m.type, m["option.data_event"] || m["option.data_hover"]), _(t, t[u], e, m, i, R)), y(t[u], m, n, d, a, c))
                        }
                    };
                    for (S = 0; S < p.products.length; S++) o.isArray(p.products[S].options) && p.products[S].options.length > w && (w = p.products[S].options.length);
                    for (f.setAttribute("data-max-option-length", w), S = 0; S < p.products.length; S++) if (!(D.length > S)) {
                        var F = document.createElement("div");
                        F.className = N.className, x.appendChild(F), F.innerHTML = N.innerHTML;
                        for (var q = F.getElementsByClassName("ladi-element"); o.isArray(p.products[S].options) && p.products[S].options.length < w;) p.products[S].options.push({is_tmp: !0});
                        R(q, p.products[S], !0, null, !1, !1)
                    }
                    v && x.classList.add("last"), d == o.const.COLLECTION_TYPE.carousel && function (t) {
                        var e = document.getElementById(t);
                        if (!o.isEmpty(e) && e.hasAttribute("data-page")) {
                            var i = "0", a = getComputedStyle(e).width, n = a,
                                ...
                                l = s[s.length - 1].getElementsByClassName("ladi-collection-item"), d = m - l.length,
                                c = "";
                            d > 0 ? (r > 1 && (i = r != s.length ? "calc(-" + a + " * " + (r - 1) + ")" : "calc(-" + a + " * " + (r - 1) + " + (" + a + " / " + m + " * " + d + "))"), n = "calc(" + a + " * " + s.length + " - (" + a + " / " + m + " * " + d + "))", c += "#" + t + " .ladi-collection-content .ladi-collection-page.last {", c += "width: calc(" + getComputedStyle(e).width + " / " + m + " * " + l.length + ");", c += "}") : (r > 1 && (i = "calc(-" + a + " * " + (r - 1) + ")"), n = "calc(" + a + " * " + s.length + ")");
                            var p = "style_collection_" + t, u = document.getElementById(p);
                            o.isEmpty(u) || u.parentElement.removeChild(u);
                            var _ = "#" + t + " .ladi-collection-content {";
                            _ += "width: " + n + ";", _ += "left: " + i + ";", _ += "}", _ += c, o.createStyleElement(p, _)
                        }
                        ...
                        if (!o.isEmpty(e)) {
                            ...
                            if (e.hasAttribute("data-max-page")) {
                                var a = i.querySelector(".ladi-collection-page.last"),
                                    n = a.getElementsByClassName("ladi-collection-item"), r = Math.ceil(n.length / m);
                                a.style.setProperty("height", (parseFloatLadiPage((parseFloatLadiPage(getComputedStyle(a).height) || 0) / u * r) || 0) + "px")
                            }
                            var s = parseFloatLadiPage(getComputedStyle(e).height) || 0, l = i.scrollHeight;
                            if (s != l) {
                                e.style.setProperty("height", l + "px");
                                var d = o.findAncestor(e.parentElement, "ladi-element");
                                o.isEmpty(d) && (d = o.findAncestor(e.parentElement, "ladi-section")), o.updateHeightElement(!0, e, d, s, l)
                            }
                        }
                    }(t), o.runEventScroll(), o.runResizeAll()
                }
            }, f = c["option.product_tag_id"], h = c["option.data_setting.value"];
        !o.isArray(f) && o.isEmpty(h) || g(t, c)
    }
...
var lightbox_run = function (t, e, i, a, n, o, r, s) {
    ...
    if (!LadiPageScript.isEmpty(l)) {
        var d = JSON.stringify({html: t, url: e, is_video: i, video_type: o, video_value: r}),
            c = Object.keys(LadiPageScript.runtime.list_lightbox_id);
        -1 == c.indexOf(d) && (LadiPageScript.runtime.list_lightbox_id[d] = c.length + 1);
        var p = LadiPageScript.runtime.list_lightbox_id[d];
        n = n + "_" + p;
        var u = document.getElementById(n), m = !1;
        ...
        var y = function () {
            if (u = document.getElementById(n), !LadiPageScript.isEmpty(u)) {
                if ("IFRAME" == u.tagName) {
                    ...
                    if (t > 0 || e > 0) {
                        var i = .8 * document.body.clientWidth, a = .8 * LadiPageScript.getHeightDevice(), o = i,
                            r = e / t * o;
                ...
                if (_ = l.getElementsByClassName("lightbox-close")[0], !LadiPageScript.isEmpty(_)) {
                    var s = LadiPageScript.getElementBoundingClientRect(u), d = 10, c = 10;
    ...
    if (!LadiPageScript.isEmpty(t)) {
        var r = "margin: auto; position: absolute; top: 0; left: 0; bottom: 0; right: 0; max-width: 80%; max-height: 80%;",
            ...
            l = t, d = LadiPageScript.createTmpElement("iframe", l, null, !0);
...
LadiPageLibraryV2.prototype.get_url = function (t, e, i) {
    ...
    if (!LadiPageScript.isEmpty(this.id)) if (LadiPageScript.runtime.has_popupx) LadiPageScript.runtime.tmp.runActionPopupX({
        url: this.id,
        target: t,
        nofollow: e,
        ...
        e && ((a = LadiPageScript.getElementAHref(i, !1)).setAttribute("rel", "nofollow"), document.body.appendChild(a)), LadiPageScript.isEmpty(t) || "_self" == t.toLowerCase() ? e ? a.click() : window.location.href = i : e ? (a.setAttribute("target", t), a.click()) : window.open(i, t), e && a.parentElement.removeChild(a)
    }
    ...
    if (!LadiPageScript.isEmpty(i)) if (LadiPageScript.runtime.has_popupx) this.show(); else {
        ...
        var r = LadiPageScript.isObject(LadiPageScript.runtime.story_page), s = function (t, e, i) {
            ...
            var o = "left" == t ? window.innerWidth : window.innerHeight, s = i - n;
            if (0 != s) {
                var l = s < 0 ? -1 * s : s, d = 0, c = 1e3;
            ...
            var e = LadiPageScript.getElementBoundingClientRect(i).top + (r ? t.scrollTop : t.scrollY), a = 0, n = 0,
            ...
            return o.forEach(function (t) {
                ...
                if ("section" == e.type && e[s + ".option.sticky"] && e[s + ".option.sticky_position"] == LadiPageScript.const.POSITION_TYPE.top) {
                    var o = document.getElementById(t);
                    LadiPageScript.isEmpty(o) || i.id != t && (n = parseFloatLadiPage(e[s + ".option.sticky_position_top"]) || 0, a = (parseFloatLadiPage(getComputedStyle(o).height) || 0) + n, "fixed" != getComputedStyle(o).position && (a *= 2))
                }
            }), {scrollTop: e -= a, stickyHeight: a, positionTop: n}
        }, d = null, c = null, p = null;
        e ? r ? i.scrollIntoView() : (d = l(window), window.scrollTo({top: d.scrollTop})) : LadiPageScript.runTimeout(function () {
            var t;
    ...
    if (!LadiPageScript.isEmpty(a)) {
        var n = [], o = !1, r = 0, s = LadiPageScript.isArray(t) ? t : [t],
            l = a.querySelectorAll('.ladi-form-item > [data-is-select-country="true"]');
        if (4 == l.length) if (LadiPageScript.isNull(t)) {
            ...
            for (r = 0; r < d.length; r++) if (LadiPageScript.isNull(t)) LadiPageScript.isObject(i) && i.only_text ? n.push(d[r].innerText) : n.push(d[r].innerHTML); else if (d[r].innerHTML = t, !LadiPageScript.isEmpty(e)) {
                var g = LadiPageScript.findAncestor(d[r], "ladi-element");
                LadiPageScript.isEmpty(g) || g.classList.add(e)
            }
            for (r = 0; r < c.length; r++) if (LadiPageScript.isNull(t)) if (c[r].classList.contains("ladi-form-control-file")) {
                var f = c[r].getAttribute("data-path-file") || "[]";
                f = JSON.parse(f), n.push(f)
            } else n.push(c[r].value); else c[r].classList.contains("ladi-form-control-file") ? (c[r].setAttribute("data-path-file", JSON.stringify(t)), c[r].value = y(t)) : (c[r].value = t, "date" == c[r].getAttribute("data-type") && (LadiPageScript.isEmpty(t) ? c[r].setAttribute("type", "text") : c[r].setAttribute("type", "date")));
            var h = !1;
            for (r = 0; r < p.length; r++) LadiPageScript.isNull(t) ? (p[r].checked && n.push(p[r].value), "checkbox" == p[r].getAttribute("type").toLowerCase() && (o = !0)) : (h = !1, "checkbox" == p[r].getAttribute("type").toLowerCase() && -1 != s.indexOf(p[r].value) && (h = !0), "radio" == p[r].getAttribute("type").toLowerCase() && s.length > 0 && s[0] == p[r].value && (h = !0), h ? p[r].checked || p[r].click() : p[r].checked && p[r].click());
            for (r = 0; r < u.length; r++) if (LadiPageScript.isNull(t)) {
            ...
            } else if (LadiPageScript.isEmpty(t)) u[r].style.setProperty("background-image", "none"); else {
            ...
            for (r = 0; r < m.length; r++) {
                ...
                if (LadiPageScript.isNull(t)) LadiPageScript.isEmpty(L) || n.push({
                    ...
                    var A = m[r].getElementsByClassName("iframe-video-preload")[0], b = null;
                    ...
                    if (LadiPageScript.isEmpty(A)) LadiPageScript.playVideo(this.id, L["option.video_type"], L["option.video_value"], L["option.video_control"]); else {
                        LadiPageScript.pauseAllVideo();
                        var T = !1;
                        if (L["option.video_type"] == LadiPageScript.const.VIDEO_TYPE.youtube) {
    ...
    var t = this.doc || document.getElementById(this.id);
    if (LadiPageScript.isEmpty(t)) this.prevSectionTabs(); else {
        var e = LadiPageScript.runtime.eventData[this.id];
    ...
    var t = this.doc || document.getElementById(this.id);
    if (LadiPageScript.isEmpty(t)) this.nextSectionTabs(); else {
        var e = LadiPageScript.runtime.eventData[this.id];
        if (!LadiPageScript.isEmpty(e)) {
            var i = null;
    ...
    if (LadiPageScript.isEmpty(e)) this.indexSectionTabs(t); else {
    ...
    if (!LadiPageScript.isEmpty(e) && !e.classList.contains("ladi-section")) {
        ...
        if (LadiPageScript.isEmpty(i)) {
            var a = LadiPageScript.isNull(t),
                ...
                o = LadiPageScript.isEmpty(n), r = 0, s = 0, l = null, d = this, c = function (t) {
            ...
            if ("none" == getComputedStyle(e).display) {
                if (a || t) if (a && o) {
                    ...
                    e.classList.remove("height-0"), e.classList.remove("overflow-hidden"), e.classList.remove("transition-collapse"), d.show(), s = parseFloatLadiPage(getComputedStyle(e).height) || 0, e.classList.add("overflow-hidden"), e.classList.add("height-0"), l = LadiPageScript.runTimeout(function () {
                ...
                } else d.show(), s = parseFloatLadiPage(getComputedStyle(e).height) || 0, c()
            } else if (a || !t) if (a && o) {
                if (l = parseFloatLadiPage(e.getAttribute("data-timeout-id")) || null, !LadiPageScript.isEmpty(l)) return;
            ...
            } else r = parseFloatLadiPage(getComputedStyle(e).height) || 0, d.hide(), c()
        }
    }
    ...
    if (!LadiPageScript.isEmpty(e)) {
        if (e.classList.contains("ladi-section")) {
            ...
            if (!LadiPageScript.isEmpty(i)) for (var a = document.querySelectorAll('.ladi-section[data-tab-id="' + i + '"]'), n = 0; n < a.length; n++) a[n].id == e.id ? a[n].classList.add("selected") : (a[n].classList.remove("selected"), window.ladi(a[n].id).hide())
        }
        ...
        if (t) {
            e.getElementsByClassName("ladi-popup").length > 0 ? (LadiPageScript.runShowPopup(!1, this.id, null, null, !0, function () {
                for (var t = document.querySelectorAll("#" + LadiPageScript.runtime.builder_section_popup_id + " .ladi-container > .ladi-element"), e = 0; e < t.length; e++) t[e].id != o.id && t[e].hasAttribute("data-popup-backdrop") && "none" != getComputedStyle(t[e]).display && LadiPageScript.runRemovePopup(t[e].id, !0)
    ...
    var a = this.doc || document.getElementById(this.id);
    if (!(LadiPageScript.isEmpty(a) || "true" != a.getAttribute("data-dropbox") || i && a.getAttribute("data-from-doc-id") == t.id && "true" != a.getAttribute("data-dropbox-backdrop") && "block" == getComputedStyle(a).display)) {
        ...
        var o = LadiPageScript.getElementBoundingClientRect(t), r = LadiPageScript.getElementBoundingClientRect(a),
            s = "";
        ...
        var l = "dropbox-" + a.id;
        if (i && !LadiPageScript.isEmpty(s)) s = "#" + a.id + ":before {" + s + "}", LadiPageScript.createStyleElement(l, s); else {
    ...
    if (!LadiPageScript.isEmpty(a)) {
        ...
        if (LadiPageScript.isEmpty(r)) {
            var s = {};
            LadiPageScript.isEmpty(e.color) || (s.color = e.color), LadiPageScript.isEmpty(e.background_color) || (s.background = "none", s["background-color"] = e.background_color), LadiPageScript.isEmpty(e.border_color) || (s["border-color"] = e.border_color), LadiPageScript.isEmpty(e.opacity) || (s.opacity = e.opacity / 100), LadiPageScript.isEmpty(e.transform_scale) || (s.transform = "scale(" + e.transform_scale / 100 + ")"), e.ontop && (s["z-index"] = "9000000090 !important"), LadiPageScript.isObject(e.custom_css) && Object.keys(e.custom_css).forEach(function (t) {
                s[t] = e.custom_css[t]
            });
            var l = [], d = "", c = "", p = "", u = "", m = "", _ = "", y = !1;
            Object.keys(s).forEach(function (t) {
                "z-index" != t.toLowerCase() ? "background" == t.toLowerCase() || t.toLowerCase().startsWith("background-") ? p += t + ": " + s[t] + ";" : "color" == t.toLowerCase() || "font" == t.toLowerCase() || t.toLowerCase().startsWith("font-") || t.toLowerCase().startsWith("text-") || t.toLowerCase().startsWith("line-") ? u += t + ": " + s[t] + ";" : c += t + ": " + s[t] + ";" : _ += t + ": " + s[t] + ";"
            });
            var g = function (t) {
            ...
            if (!LadiPageScript.isEmpty(u)) {
                ...
                document.querySelectorAll(f()).length > 0 && (i && (y = !0, m += f() + " {transition: all 150ms linear 0s;}"), d += f(n) + " {" + u + "}")
            }
...
LadiPageScript.isArray(window.ladi_fbq_data) && (window.ladi_fbq_data.forEach(function (t) {
    ...
    var i = function () {
    }, a = "top_left", n = "top_center", o = "top_right", r = "bottom_left", s = "bottom_center", l = "bottom_right";
    return i.prototype.run = function (e, i) {
        ...
        var d = t["option.sheet_id"], c = t.dataset_value, p = document.getElementById(e);
        if (p.classList.add("ladi-hidden"), !LadiPageScript.isEmpty(d) || !LadiPageScript.isEmpty(c)) {
            var u = i ? LadiPageScript.const.DESKTOP : LadiPageScript.const.MOBILE, m = t[u + ".option.position"],
            ...
            LadiPageScript.isEmpty(c) || E(c), LadiPageScript.isEmpty(d) || LadiPageScript.sendRequest("GET", "https://docs.google.com/spreadsheets/d/" + d + "/gviz/tq?tqx=out:json", null, !0, null, function (t, e, i) {
                if (i.readyState == XMLHttpRequest.DONE && 200 == e) {
                    ...
                    LadiPageScript.isObject(a) && 0 == a.parsedNumHeaders && LadiPageScript.isArray(a.rows) && a.rows.length > 0 && LadiPageScript.isObject(a.rows[0]) && LadiPageScript.isArray(a.rows[0].c) && a.rows[0].c.length > 0 && (o = [], a.rows[0].c.forEach(function (t) {
                        o.push({label: LadiPageScript.isObject(t) ? t.v : ""})
                        ...
                        if (LadiPageScript.isObject(t)) {
                            ...
                            o.forEach(function (i, a) {
                                if (LadiPageScript.isArray(t.c)) {
                                    var n = t.c[a];
                                    LadiPageScript.isObject(i) && !LadiPageScript.isEmpty(i.label) && LadiPageScript.isObject(n) && (e["gsx$" + i.label.trim().toLowerCase()] = {$t: n.v})
                                }
                            }), n.push(e)
                        }
                    }), E(n)
    ...
    return i.prototype.getEventTrackingCategory = function () {
        ...
        var n = t["option.spinlucky_setting.list_value"], o = t.dataset_value,
            r = t["option.spinlucky_setting.result_popup_id"], s = t["option.spinlucky_setting.result_message"],
            l = t["option.spinlucky_setting.max_turn"], d = a(e);
        if (!LadiPageScript.isEmpty(n) || !LadiPageScript.isEmpty(o)) {
            n = n || o, LadiPageScript.setDataReplaceStr("spin_turn_left", l - d);
            var c = document.getElementById(e), p = c.getElementsByClassName("ladi-spin-lucky-start")[0],
                u = c.getElementsByClassName("ladi-spin-lucky-screen")[0], m = "";
            n.forEach(function (t, e) {
                var i = Base64.decode(t).split("|");
                if (3 == i.length) {
                    var a = 360 / n.length * e + 180 / n.length, o = "rotate(" + (a *= -1) + "deg) translateY(-50%)";
                    m += '<div class="ladi-spin-lucky-label" style="transform: ' + o + "; -webkit-transform: " + o + ';">' + i[1].trim() + "</div>"
                }
            }), u.innerHTML = m;
            var _ = !1;
            p.addEventListener("click", function (t) {
                if (t.stopPropagation(), !_) if ((d = a(e)) >= l) LadiPageScript.showMessage(LadiPageScript.const.LANG.GAME_MAX_TURN_MESSAGE.format(l)); else {
                    _ = !0;
                    var i = [], o = 0, c = 1;
                    n.forEach(function (t, e) {
                        var a = Base64.decode(t).split("|"), n = a[0].trim(), r = a[1].trim(),
                            s = parseFloatLadiPage(a[2].trim()) || 0;
                        i.push({min: c, max: c + s - 1, value: n, text: r, percent: s, index: e}), c += s, o += s
                    });
                    for (var p = LadiPageScript.randomInt(1, o), m = null, y = 0; y < i.length; y++) if (i[y].min <= p && i[y].max >= p) {
                        m = i[y];
                        break
                    }
                    if (LadiPageScript.isEmpty(m)) _ = !1; else {
                        var g = parseFloatLadiPage(u.getAttribute("data-rotate")) || 0,
                            f = m.index * (360 / i.length) + 360 * (4 + Math.ceil(g / 360)) + 180 / i.length,
                            h = "rotate(" + f + "deg)";
                        u.setAttribute("data-rotate", f), u.style.setProperty("transform", h), u.style.setProperty("-webkit-transform", h), "NEXT_TURN" != m.value.toUpperCase() && (d++, window.ladi("_total_turn_" + e).set_cookie(d, 1));
                        LadiPageScript.runTimeout(function () {
                            "NEXT_TURN" == m.value.toUpperCase() ? LadiPageScript.isEmpty(m.text) || LadiPageScript.showMessage(m.text) : (LadiPageScript.setDataReplaceStr("coupon", m.value), LadiPageScript.setDataReplaceStr("coupon_code", m.value), LadiPageScript.setDataReplaceStr("coupon_text", m.text), LadiPageScript.setDataReplaceStr("spin_turn_left", l - d), LadiPageScript.setDataReplaceElement(!0, !1, null, null, ["coupon", "coupon_code", "coupon_text", "spin_turn_left"]), r == LadiPageScript.const.GAME_RESULT_TYPE.default ? LadiPageScript.isEmpty(s) || LadiPageScript.showMessage(s) : window.ladi(r).show(), LadiPageScript.runEventTracking(e, !1)), _ = !1
...
LadiPageScript.runtime.lang = "vi", LadiPageScript.const.LANG = {
    ...
    FORM_CAPTCHA_LOADING: "Vui lÃ²ng chá» xÃ¡c thá»±c Captcha trong giÃ¢y lÃ¡t!",
