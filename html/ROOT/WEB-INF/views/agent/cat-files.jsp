        ...
        <div class="col-lg-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Cat files</li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <table class="table table-hover">
                    ...
                    <c:forEach items="${albumitems}" var="item">
                        <tr id="item_${item.albumitemid}">
                            ...
                            <td class="text-end">
                                <a href="#" itemid="${item.albumitemid}" class="btn btn-view-item">
                                    <i class="bi bi-eye"></i>
                                </a>
                                |
                                ...
                                |
                                <a href="#" itemid="${item.albumitemid}" class="btn btn-show-source-code-item"><i class="bi bi-code"></i></a>
                            </a>
                            </td>
                        </tr>
                    </c:forEach>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="captionForm" action="/view3d/agent/${cat}/update-caption.html" class="form-horizontal" method="post" role="form">
