            ...
            <div class="col-12">
                ...
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <th class="text-end"><fmt:message key="shipping.fee"/></th>
                    ...
                    <tr class="tr-summay-group bg-warning">
                        ...
                        <td></td>
                        <td class="text-end"><span class="shippingfee"><fmt:formatNumber value="${sumaryRecord.shippingfee}" maxFractionDigits="0"/></span></td>
                    ...
                    <c:forEach items="${records}" var="rc">
                        <tr class="tr-group" data-groupid="${rc.groupid}">
                            ...
                            <td class="text-end"><span class="shippingfee"><fmt:formatNumber value="${rc.shippingfee}" maxFractionDigits="0"/></span></td>
                            <td class="text-end"><span class="finalamount"><fmt:formatNumber value="${rc.totalamount}" maxFractionDigits="0"/></span></td>
                            <c:forEach items="${products}" var="product">
