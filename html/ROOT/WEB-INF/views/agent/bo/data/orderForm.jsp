    ...
    <div class="customers-container">
        <form id="customerOrderForm" method="post" autocomplete="off">
            ...
            <div class="row mt-3">
                <div class="form-group col">
                    <select id="cfullname" name="fullname" value="${customer.fullname}" placeholder="<fmt:message key='fullname'/>" class="form-control" maxlength="255" style="height: 100%;">
                ...
                <div class="form-group col">
                    <input name="dateofbirth" class="form-control datepicker dateofbirth" value="${customer.dateofbirth}" placeholder="<fmt:message key="dateofbirth"/>" maxlength="255" />
                </div>
            </div>
            <div class="row">
                <c:if test="${not empty states}">
                    <div class="form-group col-md">
                        <select id="stateSelect" name="state" class="form-control cus-state">
            ...
            <h4 class="product-label"> <fmt:message key="label.product"/> </h4>
            <div id="item-list">
                <c:forEach begin="1" end="${maxN}" step="1" var="n">
                    <div id="product${n}container" class="form-row mt-3 item-container">
                        <div class="col-1 pt-2"><a href="#" onclick="removeItem('${n}')"><i class="bi bi-x-circle"></i></a> ${n}</div>
                        <div class="col-4 position-relative">
                            <input name="productname" id="product${n}" type="text" class="form-control" value="${items[n-1].productname}" autocomplete="off" placeholder="<fmt:message key="label.search.typing"/>">
            ...
            <div class="form-row my-3">
                <div class="col-2 pt-2">
                    <a href="#" class="btn btn-secondary" onclick="addItem()"><i class="bi bi-plus"></i></a>
                </div>
                <div class="col-2 text-end">
                    <span class="shipping-date-label"><fmt:message key="shipping.date"/></span>
                </div>
                <div class="col-3">
                ...
                <div class="col-2 text-end">
                    <span class="shipping-fee-label"><fmt:message key="shipping.fee"/></span>
                </div>
        ...
        <div class="mt-3 mb-2">
            <div class="text-center">
                <a href="javascript:void(0)" onclick="submitCustomerOrderForm('DRAFT')" class="btn btn-secondary DRAFT w-25 me-3">
                    <span class="text-white">
                    <i class="bi bi-save"></i> <fmt:message key="draft"/>
                    </span>
                </a>
                <a href="javascript:void(0)" onclick="submitCustomerOrderForm('CONFIRMED')" class="btn btn-primary CONFIRMED w-25 me-3">
                    <span class="text-white">
                    <i class="bi bi-check"></i> <fmt:message key="confirm"/>
                    </span>
                </a>
                <a href="javascript:void(0)" onclick="submitCustomerOrderForm('SHIPPING')" class="btn btn-success SHIPPING w-25 me-3">
                    <span class="text-white">
                    <i class="bi bi-coin"></i> <fmt:message key="shipping"/>
                    </span>
                </a>
...
<div class="d-none" id="item-template">
    <div id="product{n}container" class="form-row mt-3 item-container">
        <div class="col-1 pt-2"><a href="#" onclick="removeItem('{n}')"><i class="bi bi-x-circle"></i></a> {n}</div>
        <div class="col-4 position-relative">
            <input name="productname" id="product{n}" type="text" class="form-control" autocomplete="off" placeholder="<fmt:message key="label.search.typing"/>">
