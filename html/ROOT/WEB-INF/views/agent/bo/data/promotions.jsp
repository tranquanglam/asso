...
<div class="row">
    ...
    <div class="col-md-2 text-end">
        <a class="btn btn-primary" href="/bo/data/promotions/add">Add</a>
    </div>
</div>
    <div class="row mt-4">
        <div class="col-12">
            <form:form id="myForm" class="form-inline" action="/bo/data/promotions" method="GET" commandName="promoBean">
                ...
                <form:select path="level" cssClass="form-control me-2">
                    <form:option value="0">Level 0</form:option>
                    <form:option value="1">Level 1</form:option>
                    <form:option value="2">Level 2</form:option>
                </form:select>
                <form:input path="validTo" cssClass="form-control datepicker me-2" />
                <form:input  path="searchTerm" placeholder="code" maxlength="64" cssClass="input-search form-control me-2"/>
                <button type="submit" class="btn btn-secondary px-4"><span><i class="bi bi-search"></i></span></button>
