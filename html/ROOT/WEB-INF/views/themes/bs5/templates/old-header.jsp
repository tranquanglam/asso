                    ...
                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                        ...
                        <security:authorize access="isAuthenticated()">
                            <a class="dropdown-item" href="/my/profile.html">
                                <i class="bi bi-person-circle"></i><fmt:message key="label.my-profile"/>
                            </a>
                            ...
                            <a class="dropdown-item" href="#" onclick="document.getElementById('plogout').submit();">
                                <i class="bi bi-box-arrow-left"></i><fmt:message key="label.logout"/>
                            </a>
                        </security:authorize>
                        <security:authorize access="isAnonymous()">
                            <a class="dropdown-item" href="/login.html"><i class="bi bi-box-arrow-in-right"></i><fmt:message key="label.login"/></a>
                            <a class="dropdown-item" href="/forgotPassword.html"><i class="fas fa-key"></i><fmt:message key="label.forgot-password"/></a>
                            <div class="dropdown-divider" role="presentation"></div>
                            <a class="dropdown-item" href="/membershipRegister"><i class="bi bi-person-circle"></i><fmt:message key="customer.register"/></a>
                        </security:authorize>
                    </div>
                </li>
                <li class="lang-real-content">
                    <a class="dropdown-toggle no-caret text-uppercase font-weight-light" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-language" aria-hidden="true"></i> ${lang}</a>
        ...
        <header class="header header-transparent" id="header-main">
                    ...
                    <div class="navbar-nav align-items-center">
                        ...
                        <div class="ml-auto">
                            <ul class="nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#" data-action="popup-cart-items-open" data-target="#popup-cart-items"><span id="cart-items-badge" class="fa-stack fa-1x has-badge" data-count="0"><i class="bi bi-cart-plus fa-stack-1x"></i></span></a>
                                </li>
            ...
            <nav class="navbar navbar-main navbar-expand-lg navbar-transparent navbar-dark bg-dark" id="navbar-main">
                <div class="container px-lg-0">
                    ...
                    <button class="navbar-toggler pr-0" type="button" data-bs-toggle="collapse" data-target="#navbar-main-collapse" aria-controls="navbar-main-collapse" aria-expanded="false" aria-label="Toggle navigation">
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <li class="nav-item dropdown dropdown-animate" data-bs-toggle="hover">
                                                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">${menuname}</a>
