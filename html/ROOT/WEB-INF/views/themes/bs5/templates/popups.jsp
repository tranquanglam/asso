        ...
        <div class="omnisearch-form">
            <div class="form-group">
                <div class="input-group input-group-merge input-group-flush">
                    ...
                    <input type="text" class="form-control" id="omnisearch-search-input" placeholder="<fmt:message key='label.search.typing'/>">
                </div>
            </div>
        </div>
        <div class="omnisearch-suggestions">
            <p class="heading h6"><fmt:message key="label.search.suggestion"/>
            </p>
            <div class="row">
                <div class="col-12">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="mt-3 btn-checkout">
                        <div class="text-end">
                            <a href="/cart" class="btn btn-sm btn-outline-primary btn-icon rounded-pill">
                                <span class="btn-inner--text"><fmt:message key="title.shopping-cart"/></span>
                            </a>
