                        ...
                        <div class="sidebar-widget">
                            <div class="">
                                ...
                                <c:if test="${not empty product.manufacturer}">
                                    <p>
                                        <i class="bi bi-pin-map"></i>${product.manufacturer.address}
                                    </p>
                                </c:if>
                            </div>
                            <div class="mt-3">
                                <c:forEach var="productprice" items="${productprices}" varStatus="pcount" end="1">
                                    <h3 class="text-primary"><fmt:formatNumber value="${productprice.price * currencyrate}" minFractionDigits="${maxF}" maxFractionDigits="${maxF}"/> ${scurrency}</h3>
                                </c:forEach>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="sidebar-widget mb-0 py-2 pt-3">
                            <div class="mt-3">
                                ${lang eq 'en' ? product.description : product.descriptionvi}
                                    <div class="sform-container sform-field-rounded-0 sform-field-padding-1 " data-code="sform-206">
                                    </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 pt-2">
                            ...
                            <c:if test="${not empty keywords}">
                                <div class="sidebar-widget mb-0">
                                    <h3 class="mb-3"> <fmt:message key="label.keyword"/> </h3>
                                    <c:forEach var="keyword" items="${keywords}">
                                        <a href="/products.html?q=${keyword}"><span class="badge bg-secondary text-dark">${keyword}</span></a>
                                    </c:forEach>
                                </div>
