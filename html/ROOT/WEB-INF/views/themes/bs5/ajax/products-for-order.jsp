                                            ...
                                            <c:when test="${product.quantity gt 0}">
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <button class="btn btn-sm btn-secondary btn-icon order-minus-btn" data-n="${n}"><i class="bi bi-dash"></i></button>
                                                    </div>
                                                    ...
                                                    <div class="input-group-append">
                                                        <button class="btn btn-sm btn-primary btn-icon order-plus-btn" data-n="${n}"><i class="bi bi-plus"></i></button>
                                                    </div>
                                                </div>
                                            </c:when>
                                            <c:otherwise>
