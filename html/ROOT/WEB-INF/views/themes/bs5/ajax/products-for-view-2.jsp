...
<style>
    ...
    .bg-gradient-primary .order-sidebar .order-sidebar-item .cat-link.active {
        ...
        <div class="col-12 col-md-2 order-sidebar pl-0 pr-0">
            <c:forEach items="${categories}" var="cat" varStatus="theCount">
                <div class="order-sidebar-item border-bottom p-3">
                    <span class="badge badge-pill badge-info mr-3">${theCount.count}</span> <a href="javascript:void(0)"
                                                                                               class="catalogue cat-link"
                                                                                               data-cat="${cat.nameurl}"
                                                                                               data-targetid="ajax-products-by-cat"> ${cat.name}</a>
                </div>
            </c:forEach>
        </div>
        <main class="col-12 col-md-10 py-md-3 pl-md-3" role="main">
            <div class="order-main-content" id="ajax-products-by-cat" maxN="${maxN}" query="${q}">
