    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <section class="slice ">
                    <span class="tongue tongue-top"><i class="bi bi-caret-up-fill"></i></span>
                    <div class="container">
                        <%--<div class="mb-5 text-center">
                            <h3 class=""><fmt:formatDate value="${fromDate}" pattern="dd MMM yyyy"/></h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 mt-4 ">
                                <c:choose>
                                    <c:when test="${not empty productcalendars}">
                                        <button id="btnBookNow" class="btn btn-primary w-100 d-none" onclick="bookAppointment(this)"><fmt:message key="book-now"/></button>
                                    </c:when>
                                    <c:otherwise></c:otherwise>
                                </c:choose>
                            </div>
