...
<body>
<span id="myfile-url">${albumitem.url}</span>
...
<script type="module">
    ...
    import { IFCLoader } from '/themes/grayscale/js/three/jsm/loaders/IFCLoader.js';
    ...
    function init() {
        ...
        ifcLoader.ifcManager.setWasmPath( '/themes/grayscale/js/three/jsm/loaders/ifc/' );
        let fileurl = document.getElementById('myfile-url').innerHTML;
