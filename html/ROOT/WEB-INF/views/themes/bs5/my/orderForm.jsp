    ...
    <div class="customers-container">
        <form id="customerOrderForm" method="post" autocomplete="off">
            ...
            <c:forEach begin="1" end="${maxN}" step="1" var="n">
                <div id="product${n}container" class="form-row mt-3 item-container">
                    <div class="col-1"><a href="#" onclick="removeItem('${n}')"><i class="bi bi-trash"></i></a> ${n}</div>
                    <div class="col-3">
        ...
        <div class="mt-3 mb-2">
            <div class="text-center">
                <a href="javascript:void(0)" onclick="submitCustomerOrderForm('DRAFT')" class="btn btn-secondary w-25 me-3">
                    <span class="text-white">
                    <i class="bi bi-save"></i> <fmt:message key="draft"/>
                    </span>
                </a>
                <a href="javascript:void(0)" onclick="submitCustomerOrderForm('CONFIRMED')" class="btn btn-primary  w-25 me-3">
                    <span class="text-white">
                    <i class="bi bi-check"></i> <fmt:message key="confirm"/>
                    </span>
                </a>
                <a href="javascript:void(0)" onclick="submitCustomerOrderForm('SHIPPING')" class="btn btn-success w-25 me-3">
                    <span class="text-white">
