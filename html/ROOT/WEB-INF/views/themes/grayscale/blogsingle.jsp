                    ...
                    <article class="mg-post">
                        <header>
                            ...
                            <div class="mg-post-meta">
                                ...
                                <span><a href="https://www.facebook.com/sharer/sharer.php?u=https://${site.domain}${desUrl}&title=${blog.title}" target="_blank"><i class="bi bi-facebook" aria-hidden="true"></i></a></span>
                                <span><a href="https://twitter.com/intent/tweet?hashtags=${site.domain}&url=https://${site.domain}${desUrl}&text=${blog.title}" target="_blank"><i class="bi bi-twitter" aria-hidden="true"></i></a></span>
                            </div>
                        </header>
                        ...
                        <footer class="clearfix">
                            <div class="mg-single-post-tags tagcloud">
                                <c:forEach items="${keywords}" var="keyword">
                                    <a href="/blog?q=${keyword}">${keyword}</a>
                                </c:forEach>
                            </div>
                        </footer>
                    </article>
