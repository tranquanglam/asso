...
<div class="section-provider-calendar">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-5 appointments-container p-0">
                <div class="card card-custom gutter-b">
                    <div class="card-header border-0">
                        <c:if test="${not empty appointments}">
                        <div class="mt-2">
                            <a href="javascript:void(0)" class="btn btn-outline-primary btn-appointments">Appointments</a>
                            <a href="javascript:void(0)" class="btn btn-outline-success btn-available-slots">Available slots</a>
                            <a href="javascript:void(0)" class="btn btn-outline-secondary btn-reports">Reports</a>
                        </div>
                        </c:if>
                        <div class="card-toolbar"><strong class="sdate">${sdate}</strong></div>
                    </div>
                    <div class="card-body">
                        <c:choose>
                            <c:when test="${not empty appointments}">
                                <ul class="list-group mt-3 mb-3">
                                    <c:forEach items="${appointments}" var="em">
                                        <li class="list-group-item appointment-item ${em.status}">
                                    ...
                                    <li class="list-group-item appointment-item BOOKABLE">
...
<div class="d-none fake-guest">
    <div class="email">${fakeGuest.email}</div>
    <div class="access_token">${fakeGuest.access_token}</div>
</div>