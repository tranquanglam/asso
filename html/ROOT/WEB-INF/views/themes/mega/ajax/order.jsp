    ...
    <div class="container text-left">
        <div class="row">
            <div class="col-lg-8 px-0 px-md-1">
                <p class="product-label h4"><fmt:message key="title.shopping-cart"/></p>
                <div id="item-list">
                        ...
                        <div id="product${n}container" class="form-row mt-3 item-container active">
                            ...
                            <div class="col-10">
                                <div class="row">
                                    ...
                                    <div class="col-2">
                                        <a href="javascript:void(0)" data-n="${n}" class="remove-order-item-btn"><i class="fa fa-trash"></i></a>
                                        <a href="javascript:void(0)" data-n="${n}" class="readd-order-item-btn text-white"><i class="fa fa-plus"></i></a>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                            ...
                                            <c:when test="${numavailable gt 0}">
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <a href="javascript:void(0)" class="btn btn-sm btn-secondary order-minus-btn" data-n="${n}"><i class="fas fa-minus"></i></a>
                                                    </div>
                                                    <input name="quantity" data-n="${n}" type="text" class="form-control change-update-product-price" value="${initqty}" min="0" max="${numavailable}">
                                                    <div class="input-group-append">
                                                        <a href="javascript:void(0)" class="btn btn-sm btn-primary order-plus-btn" data-n="${n}"><i class="fas fa-plus"></i></a>
                                                    </div>
                                                </div>
                                            </c:when>
                                            <c:otherwise>
            ...
            <div class="col-lg-4">
                ...
                <div class="row">
                    ...
                    <div class="form-group form-group-destination col-12">
                        <select name="destinationid" class="form-control custom-select cus-destination">
                ...
                <div class="mt-3 mb-2">
                    <div class="text-right action-submit-btn">
