...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/themes/mega/css/select2.min.css" />
    <link rel="stylesheet" type="text/css" href="/themes/mega/css/bootstrap-datepicker3.min.css" />
    <link rel="stylesheet" type="text/css" href="/themes/mega/css/styles-1.1.min.css?v=1.01" />
    <link rel="stylesheet" type="text/css" href="https://initwebs.com/themes/mega/css/layout.min.css" />
    <link rel="stylesheet" type="text/css" href="/themes/mega/css/aos.css" />
    ...
    <style>
        :root {
            ...
            --main-header-bg-color: ${siteHeaderColor};
            --main-footer-bg-color: ${siteFooterColor};
            --main-header-txt-color: ${siteHeaderTextColor};
...
<div id="config-tool" class="closed">
    <a id="config-tool-cog">
        <span id="cart-badge" class="fa-stack fa-1x has-badge" data-count="0">
    ...
    <div id="config-tool-options">
        ...
        <br/>
        <a href="#" class="btn btn-success btn-book-now"><fmt:message key="book-now"/></a>
        <a href="#" id="config-tool-close" class="float-right"><i class="fa fa-2x fa-arrow-circle-right" aria-hidden="true"></i></a>
    </div>
</div>
<div class="d-none">
    <form action="/booking.html" method="post" id="product-booking-form">
...
<script type="text/javascript" src="/themes/mega/js/aos.js"></script>
<script type="text/javascript" src="/themes/mega/js/jarallax.min.js"></script>
<script type="text/javascript" src="/themes/mega/js/jarallax-element.min.js"></script>
<script type="text/javascript" src="https://initwebs.com/themes/mega/js/layout.min.js"></script>
<script type="text/javascript" src="/themes/mega/js/main-1.3.min.js?v=1.03"></script>
        ...
        <script>
            function initGG() {
                gapi.load('auth2', function() {
                    gapi.auth2.init({
                        clientId: "${applicationScope[googleConfig].oauth.appId}" 0392195745
                    });
                });
            }
            function logout() {
