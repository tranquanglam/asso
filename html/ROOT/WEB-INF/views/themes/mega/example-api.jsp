...
<div class="container mt-5">
    <ul class="nav nav-tabs md-tabs">
        ...
        <li class="nav-item"><a id="mybooking" class="nav-link" href="#mybooking-content" aria-controls="mybooking-content" role="tab" data-toggle="tab"><strong class="text-uppercase">My booking</strong></a></li>
    ...
    <div class="tab-content card pt-5">
        ...
        <div role="tabpanel" class="tab-pane fade group" id="mybooking-content">
            <div id="mybookingData" class="row">
...
<div id="mybookingTemplate" class="d-none">
    <div class="row col-12" style="padding: 10px;">
        <div class="col-2"><a href="#" onclick="showBookinginfo('{bookingid}')">{bookingnumber}</a></div>
...
<script type="text/javascript" src="/themes/mega/js/client.js"></script>
<script>
    ...
    function showBookinginfo(bookingnumber) {
        $("#bookingnumber").html(bookingnumber);
        $("#bookingnumber").trigger("click");
    }
</script>
</body>
</html>
