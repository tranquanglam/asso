...
Client.prototype._login = function _login() {
    ...
    $.ajax({
        ...
        beforeSend: function(xhr) {
            ...
            xhr.setRequestHeader("scope", "write");
        },
        statusCode: {
...
Client.prototype._myprofile = function _myprofile() {
    $.ajax({
        url: '/api/v0/supplier/myprofile.json',
        type: 'POST',
        contentType: "application/json",
        dataType: "json",
        success: function(result) {
...
Client.prototype._updateMyprofile = function _updateMyprofile() {
    ...
    $.ajax({
        url: '/api/v0/supplier/updateMyprofile.json',
        type: 'POST',
...
Client.prototype._supplierbooking = function _mybooking() {
    var requestMyBooking = {};
    requestMyBooking.version = "1.0";
    requestMyBooking.fromDate = '2019-03-01';
    requestMyBooking.toDate = '2030-05-01';
    var mybookingEle = $('#supplierbookingTemplate').html();
    var mybookingHeader = $('#supplierbookingHeader').html();
    $.ajax({
        url: '/api/v0/supplier/mybooking.json',
        type: 'POST',
        contentType: "application/json",
        ...
        success: function(result) {
            if (result.totalRecords) {
                $("#mySupplierBookingData").html('');
                $("#mySupplierBookingData").append(mybookingHeader);
                for (var i=0; i< result.productorders.length; i++) {
                    ...
                    $("#mySupplierBookingData").append(bEle);
                }
            } else {
                $("#mySupplierBookingData").html(result.errorMessage);
            }
        }
    });
};

Client.prototype._supplierbookingdetails = function _bookingdetails() {
    ...
    $.ajax({
        ...
        success: function(result) {
            if (result.ordernumber) {
                ...
                $("#supplierbookinginfo").html(result.errorMessage);
            }
...
Client.prototype._setupEventHandlers = function _setupEventHandlers() {
    ...
    $('#supplierbooking').click(this._supplierbooking.bind(this));
    $("#supplierbookingnumber").click(this._supplierbookingdetails.bind(this));
};
